CLASS z2ui6_cl_xml_view_cc DEFINITION PUBLIC.
...
CLASS z2ui6_cl_xml_view_cc IMPLEMENTATION.
  ...
  METHOD camera_picture.
    ...
    mo_view->_generic( name   = `CameraPicture`
                       ...
                       t_prop = VALUE #( ( n = `id`         v = id )
                                         ...
                                         ( n = `width`      v = width )
                                         ( n = `OnPhoto`    v = onphoto )
                                         ( n = `autoplay`   v = z2ui6_cl_ui5_util_context=>boolean_abap_2_json( autoplay ) )
  ...
  METHOD file_uploader.
    ...
    mo_view->_generic(
        ...
        t_prop = VALUE #( (  n = `placeholder`        v = placeholder )
                          ...
                          (  n = `path`               v = path )
                          (  n = `value`              v = value )
                          (  n = `iconOnly`           v = z2ui6_cl_ui5_util_context=>boolean_abap_2_json( icononly ) )
                          (  n = `buttonOnly`         v = z2ui6_cl_ui5_util_context=>boolean_abap_2_json( buttononly ) )
                          (  n = `buttonText`         v = buttontext )
                          (  n = `uploadButtonText`   v = uploadbuttontext )
                          (  n = `fileType`           v = filetype )
                          (  n = `checkDirectUpload`  v = z2ui6_cl_ui5_util_context=>boolean_abap_2_json( checkdirectupload ) )
                          (  n = `icon`           v = icon )
                          (  n = `enabled`         v = z2ui6_cl_ui5_util_context=>boolean_abap_2_json( enabled ) ) ) ).
  ...
  METHOD geolocation.
    ...
    mo_view->_generic( name   = `Geolocation`
                       ...
                       t_prop = VALUE #(
                           ...
                           ( n = `speed`  v = speed )
                           ( n = `heading`  v = heading )
                           ( n = `enableHighAccuracy`  v = z2ui6_cl_ui5_util_context=>boolean_abap_2_json( enablehighaccuracy ) )
                           ( n = `timeout`  v = timeout )
                ) ).
  ...
  METHOD timer.
    ...
    mo_view->_generic( name   = `Timer`
                       ...
                       t_prop = VALUE #( ( n = `delayMS`  v = delayms )
                                         ( n = `finished`  v = finished )
                                         ( n = `checkActive`  v = z2ui6_cl_ui5_util_context=>boolean_abap_2_json( checkactive ) )
                                         ( n = `checkRepeat`  v = z2ui6_cl_ui5_util_context=>boolean_abap_2_json( checkrepeat ) )
                ) ).
  ...
  METHOD lp_title.
    ...
    mo_view->_generic(
        ...
        t_prop = VALUE #( ( n = `title`  v = title )
                          ( n = `ApplicationFullWidth`  v = z2ui6_cl_ui5_util_context=>boolean_abap_2_json( applicationfullwidth ) ) ) ).
  ...
  METHOD dirty.
    ...
    mo_view->_generic( name   = `Dirty`
                       ns     = `z2ui5`
                       t_prop = VALUE #( ( n = `isDirty`  v = z2ui6_cl_ui5_util_context=>boolean_abap_2_json( isdirty ) ) ) ).
