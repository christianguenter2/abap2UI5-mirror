CLASS z2ui6_cl_pop_file_dl DEFINITION PUBLIC.
...
CLASS z2ui6_cl_pop_file_dl IMPLEMENTATION.
  ...
  METHOD view_display.
    ...
    IF mv_check_download = abap_true.
      DATA(lv_csv_x) = z2ui6_cl_ui5_util_context=>conv_get_xstring_by_string( mv_value ).
      DATA(lv_base64) = z2ui6_cl_ui5_util_context=>conv_encode_x_base64( lv_csv_x ).
