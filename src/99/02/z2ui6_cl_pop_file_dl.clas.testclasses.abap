...
CLASS ltcl_test IMPLEMENTATION.
  ...
  METHOD test_factory.
    ...
    DATA(lo_pop) = z2ui6_cl_pop_file_dl=>factory( i_file = `test_content`
                                                  i_name = `test.csv` ).
  ...
  METHOD test_result_initial.
    ...
    DATA(lo_pop) = z2ui6_cl_pop_file_dl=>factory( `abc` ).
...
CLASS ltcl_test_roundtrip IMPLEMENTATION.
  ...
  METHOD test_init_displays_popup.
    ...
    DATA(lo_pop) = z2ui6_cl_pop_file_dl=>factory( i_file  = `col1;col2`
  ...
  METHOD test_confirm_starts_dl.
    ...
    DATA(lo_pop) = z2ui6_cl_pop_file_dl=>factory( `col1;col2` ).
