...
CLASS ltcl_test IMPLEMENTATION.
  ...
  METHOD test_factory.
    ...
    DATA(lo_pop) = z2ui6_cl_pop_demo_output=>factory( NEW ltcl_output_stub( ) ).
  ...
  METHOD test_factory_custom.
    ...
    DATA(lo_pop) = z2ui6_cl_pop_demo_output=>factory(
...
CLASS ltcl_test_roundtrip IMPLEMENTATION.
  ...
  METHOD test_init_displays_popup.
    ...
    DATA(lo_pop) = z2ui6_cl_pop_demo_output=>factory( i_output = NEW z2ui6_cx_ui5_util_error( `x` )
                                                      i_title  = `Demo Title` ).
  ...
  METHOD test_toggle_fullscreen.
    ...
    DATA(lo_pop) = z2ui6_cl_pop_demo_output=>factory( NEW z2ui6_cx_ui5_util_error( `x` ) ).
    ...
    cl_abap_unit_assert=>assert_not_initial(
        VALUE string( mo_action->ms_next-t_action_front[
                          slot   = z2ui6_if_client=>cs_view-main
                          method = z2ui6_if_ui5_types=>cs_slot_action-display ]-xml OPTIONAL ) ).
