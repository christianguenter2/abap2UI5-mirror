CLASS z2ui6_cl_pop_demo_output DEFINITION PUBLIC FINAL CREATE PUBLIC.
  ...
  PUBLIC SECTION.
    ...
    CLASS-METHODS factory
      ...
      RETURNING
        VALUE(r_result) TYPE REF TO z2ui6_cl_pop_demo_output.
...
CLASS z2ui6_cl_pop_demo_output IMPLEMENTATION.
  ...
  METHOD render_page.
    ...
    DATA(page) = z2ui6_cl_xml_view=>factory( )->shell(
        )->page(
            title          = title
