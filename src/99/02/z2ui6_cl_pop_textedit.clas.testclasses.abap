...
CLASS ltcl_test IMPLEMENTATION.
  ...
  METHOD test_factory.
    ...
    DATA(lo_pop) = z2ui6_cl_pop_textedit=>factory( ).
  ...
  METHOD test_factory_editable.
    ...
    DATA(lo_pop2) = z2ui6_cl_pop_textedit=>factory( ).
...
CLASS ltcl_test_roundtrip IMPLEMENTATION.
  ...
  METHOD test_init_displays_popup.
    ...
    DATA(lo_pop) = z2ui6_cl_pop_textedit=>factory( i_textarea = `Hello Text`
  ...
  METHOD test_confirm.
    ...
    DATA(lo_pop) = z2ui6_cl_pop_textedit=>factory( `Hello Text` ).
