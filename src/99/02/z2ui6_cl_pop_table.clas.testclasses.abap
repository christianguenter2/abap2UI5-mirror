...
CLASS z2ui6_cl_pop_table DEFINITION LOCAL FRIENDS ltcl_test.
...
CLASS ltcl_test IMPLEMENTATION.
  ...
  METHOD test_factory.
    ...
    DATA(lo_pop) = z2ui6_cl_pop_table=>factory( lt_tab ).
  ...
  METHOD test_factory_title.
    ...
    DATA(lo_pop) = z2ui6_cl_pop_table=>factory( i_tab   = lt_tab
