CLASS z2ui6_cl_pop_to_select DEFINITION PUBLIC.
...
CLASS z2ui6_cl_pop_to_select IMPLEMENTATION.
  ...
  METHOD factory.
    ...
    r_result->mr_tab            = z2ui6_cl_ui5_util_context=>conv_copy_ref_data( i_tab ).
  ...
  METHOD display.
    ...
    DATA(tab) = popup->table_select_dialog(
        items            = |\{path:'|
                          ...
                          && z2ui6_cl_ui5_util_context=>boolean_abap_2_json( descending )
                          && | \} \}|
    ...
    DATA(lt_comp) = z2ui6_cl_ui5_util_context=>rtti_get_t_attri_by_any( <tab_out> ).
    ...
    LOOP AT lt_comp INTO ls_comp.
      DATA(text) = COND #(
                     LET data_element_name = z2ui6_cl_ui5_util_context=>rtti_get_ddic_type_name( ls_comp-type )
                         medium_label = z2ui6_cl_ui5_util_context=>rtti_get_data_element_texts( data_element_name )-medium IN
  ...
  METHOD set_output_table.
    ...
    DATA(ls_sel_tab_type) = z2ui6_cl_ui5_util_context=>rtti_create_sel_tab_type( ir_tab = mr_tab
  ...
  METHOD on_event_search.
    ...
    z2ui6_cl_ui5_util_context=>itab_filter_by_val( EXPORTING val = client->get_event_arg( 1 )
