...
CLASS ltcl_test IMPLEMENTATION.
  ...
  METHOD test_factory.
    ...
    DATA(lo_pop) = z2ui6_cl_pop_error=>factory( lx ).
  ...
  METHOD test_factory_util_error.
    ...
    DATA(lx) = NEW z2ui6_cx_ui5_util_error( val = `test error` ).
    DATA(lo_pop) = z2ui6_cl_pop_error=>factory( lx ).
    cl_abap_unit_assert=>assert_bound( lo_pop ).
  ...
  METHOD test_factory_custom.
    ...
    DATA(lx) = NEW z2ui6_cx_ui5_util_error( val = `custom error` ).
    DATA(lo_pop) = z2ui6_cl_pop_error=>factory(
      x_root  = lx
...
CLASS ltcl_test_roundtrip IMPLEMENTATION.
  ...
  METHOD test_init_displays_error.
    ...
    DATA(lo_pop) = z2ui6_cl_pop_error=>factory( NEW z2ui6_cx_ui5_util_error( `MY_ERROR_TEXT` ) ).
