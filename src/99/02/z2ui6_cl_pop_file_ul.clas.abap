CLASS z2ui6_cl_pop_file_ul DEFINITION PUBLIC.
  ...
  METHOD z2ui6_if_app~main.
    ...
    CASE lv_event.
      ...
      WHEN `UPLOAD`.
        ...
        DATA(lv_data) = z2ui6_cl_ui5_util_context=>conv_get_xstring_by_data_uri( mv_value ).
        ms_result-value = z2ui6_cl_ui5_util_context=>conv_get_string_by_xstring( lv_data ).
