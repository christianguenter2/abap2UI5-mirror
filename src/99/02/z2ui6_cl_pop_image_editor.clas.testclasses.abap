...
CLASS ltcl_test IMPLEMENTATION.
  ...
  METHOD test_factory.
    DATA(lo_pop) = z2ui6_cl_pop_image_editor=>factory(
  ...
  METHOD test_factory_defaults.
    DATA(lo_pop) = z2ui6_cl_pop_image_editor=>factory( `test_img` ).
...
CLASS ltcl_test_roundtrip IMPLEMENTATION.
  ...
  METHOD test_init_displays_popup.
    ...
    DATA(lo_pop) = z2ui6_cl_pop_image_editor=>factory( iv_image = `data:image/png;base64,OLD`
  ...
  METHOD test_save.
    ...
    DATA(lo_pop) = z2ui6_cl_pop_image_editor=>factory( `data:image/png;base64,OLD` ).
    client_create( lo_pop ).
