...
CLASS ltcl_test IMPLEMENTATION.
  ...
  METHOD test_factory.
    ...
    DATA(lo_pop) = z2ui6_cl_pop_file_ul=>factory( ).
  ...
  METHOD test_factory_with_path.
    ...
    DATA(lo_pop) = z2ui6_cl_pop_file_ul=>factory( i_path = `/tmp/myfile.csv` ).
...
CLASS ltcl_test_roundtrip IMPLEMENTATION.
  ...
  METHOD test_init_displays_popup.
    ...
    DATA(lo_pop) = z2ui6_cl_pop_file_ul=>factory( i_title = `Upload Title` ).
