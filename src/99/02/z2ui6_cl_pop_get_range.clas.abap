CLASS z2ui6_cl_pop_get_range DEFINITION PUBLIC.
  ...
  PUBLIC SECTION.
    ...
    TYPES:
      BEGIN OF ty_s_result,
        t_range         TYPE z2ui6_cl_ui5_util_context=>ty_t_range,
...
CLASS z2ui6_cl_pop_get_range IMPLEMENTATION.
  ...
  METHOD factory.
    ...
    z2ui6_cl_ui5_util_context=>itab_corresponding( EXPORTING val = t_range
  ...
  METHOD z2ui6_if_app~main.
    ...
    IF client->check_on_init( ).
      mt_mapping = z2ui6_cl_ui5_util_context=>filter_get_token_range_mapping( ).
      ...
      LOOP AT ms_result-t_range REFERENCE INTO DATA(lr_range).
        INSERT VALUE #( low    = lr_range->low
                        ...
                        key    = z2ui6_cl_ui5_util_context=>uuid_get_c32( )
    ...
    CASE client->get( )-event.
      ...
      WHEN `POPUP_ADD`.
        INSERT VALUE #( key = z2ui6_cl_ui5_util_context=>uuid_get_c32( ) ) INTO TABLE mt_filter.
