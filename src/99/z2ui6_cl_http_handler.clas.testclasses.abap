...
CLASS ltcl_test_alias IMPLEMENTATION.
  ...
  METHOD test_alias_resolves.
    ...
    DATA(ls_result) = z2ui6_cl_http_handler=>_http_get( ).
  ...
  METHOD test_alias_is_not_a_fork.
    ...
    cl_abap_unit_assert=>assert_equals(
        exp = z2ui6_cl_ui5_http_handler=>_http_get( )-body
        act = z2ui6_cl_http_handler=>_http_get( )-body ).
    ...
    cl_abap_unit_assert=>assert_equals(
        exp = z2ui6_cl_ui5_http_handler=>_http_post( ls_req )-status_code
        act = z2ui6_cl_http_handler=>_http_post( ls_req )-status_code ).
