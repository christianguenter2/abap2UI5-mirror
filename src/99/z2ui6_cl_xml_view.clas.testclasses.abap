...
CLASS ltcl_unit_test IMPLEMENTATION.
  METHOD test_create.
    ...
    DATA lo_view TYPE REF TO z2ui6_cl_xml_view.
    DATA lv_xml TYPE string.
    lo_view = z2ui6_cl_xml_view=>factory( ).
  ...
  METHOD test_factory_popup.
    ...
    DATA lo_popup TYPE REF TO z2ui6_cl_xml_view.
    DATA lv_xml TYPE string.
    DATA temp1 TYPE xsdboolean.
    lo_popup = z2ui6_cl_xml_view=>factory_popup( ).
  ...
  METHOD test_shell_page.
    ...
    lv_xml = z2ui6_cl_xml_view=>factory(
      )->shell(
      )->page( `My Page`
      )->stringify( ).
  ...
  METHOD test_dialog.
    ...
    lv_xml = z2ui6_cl_xml_view=>factory_popup(
  ...
  METHOD test_get_parent.
    ...
    DATA lo_view TYPE REF TO z2ui6_cl_xml_view.
    DATA lo_page TYPE REF TO z2ui6_cl_xml_view.
    DATA lo_vbox TYPE REF TO z2ui6_cl_xml_view.
    DATA lo_parent TYPE REF TO z2ui6_cl_xml_view.
    DATA lv_xml TYPE string.
    lo_view = z2ui6_cl_xml_view=>factory( ).
  ...
  METHOD test_multi_get_parent.
    ...
    DATA lo_page TYPE REF TO z2ui6_cl_xml_view.
    DATA lo_vbox TYPE REF TO z2ui6_cl_xml_view.
    DATA lo_hbox TYPE REF TO z2ui6_cl_xml_view.
    DATA lo_text TYPE REF TO z2ui6_cl_xml_view.
    DATA lo_back TYPE REF TO z2ui6_cl_xml_view.
    DATA lv_xml TYPE string.
  ...
  METHOD test_generic_method.
    ...
    DATA temp1 TYPE z2ui6_if_types=>ty_t_name_value.
  ...
  METHOD test_split_container.
    ...
    DATA(lo_split) = z2ui6_cl_xml_view=>factory(
      )->page( `Test`
...
CLASS ltcl_test_xml_output IMPLEMENTATION.
  ...
  METHOD test_attribute_escaping.
    ...
    DATA(lv_xml) = z2ui6_cl_xml_view=>factory(
        )->shell(
        )->page( `Escape Test`
  ...
  METHOD test_z2ui5_cc_namespace.
    ...
    DATA(lv_xml) = z2ui6_cl_xml_view=>factory_popup(
        )->dialog( `NS Test`
        )->content(
        )->_z2ui5(
        )->timer( `MY_EVENT`
