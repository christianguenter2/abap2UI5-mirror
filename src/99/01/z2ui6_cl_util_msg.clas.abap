CLASS z2ui6_cl_util_msg DEFINITION PUBLIC
  FINAL CREATE PUBLIC.
  PUBLIC SECTION.
  ...
  PROTECTED SECTION.
    ...
    CLASS-METHODS msg_get_rap_meta
      IMPORTING
        val           TYPE any
      RETURNING
        VALUE(result) TYPE z2ui6_cl_util=>ty_t_name_value.
...
CLASS z2ui6_cl_util_msg IMPLEMENTATION.
  ...
  METHOD msg_get_by_sy.
    ...
    result = msg_get( z2ui6_cl_util=>context_get_sy( ) ).
  ...
  METHOD msg_get_collect.
    ...
    result = concat_lines_of(
      ...
      sep   = z2ui6_cl_util=>cv_char_util_newline ).
  ...
  METHOD check_is_rap_struct.
    ...
    LOOP AT lt_attri REFERENCE INTO ls_attri.
      ...
      CHECK sy-subrc = 0.
      CHECK z2ui6_cl_util=>rtti_get_type_kind( <tab> ) = cl_abap_datadescr=>typekind_table.
  ...
  METHOD msg_get_rap.
    ...
    LOOP AT lt_attri REFERENCE INTO DATA(ls_attri).
      ...
      LOOP AT <ftab> ASSIGNING FIELD-SYMBOL(<row>).
        IF z2ui6_cl_util=>rtti_get_type_kind( <row> ) = cl_abap_datadescr=>typekind_oref.
  ...
  METHOD msg_get_rap_flatten.
    ...
    LOOP AT lt_attri REFERENCE INTO DATA(ls_attri).
      ...
      DATA(lv_sub_kind) = z2ui6_cl_util=>rtti_get_type_kind( <comp> ).
