CLASS ltcl_unit_test DEFINITION FINAL
  ...
  PRIVATE SECTION.
    ...
    METHODS build_page_view
      RETURNING VALUE(result) TYPE REF TO z2ui6_cl_util_xml.
...
CLASS ltcl_unit_test IMPLEMENTATION.
  ...
  METHOD test_factory.
    ...
    DATA(lo_view) = z2ui6_cl_util_xml=>factory( )->__( `View` ).
  ...
  METHOD test_fragment_definition.
    ...
    DATA(lo_popup) = z2ui6_cl_util_xml=>factory( )->__( n = `FragmentDefinition` ns = `core`
  ...
  METHOD test_shell_page.
    ...
    DATA(lv_xml) = z2ui6_cl_util_xml=>factory(
      )->__( n = `View` ns = `mvc`
      )->__( `Shell`
      )->__( n = `Page`
  ...
  METHOD test_leaf.
    ...
    DATA(lo_page) = z2ui6_cl_util_xml=>factory(
      )->__( n = `View` ns = `mvc`
      )->__( n = `Page` a = `title` v = `Test` ).
  ...
  METHOD test_nav_up.
    ...
    DATA(lo_root) = z2ui6_cl_util_xml=>factory( ).
  ...
  METHOD test_simple_form.
    ...
    DATA(lo_form) = z2ui6_cl_util_xml=>factory(
      )->__( n = `View` ns = `mvc`
  ...
  METHOD build_page_view.
    ...
    result = z2ui6_cl_util_xml=>factory(
      )->__( n = `View` ns = `mvc`
