CLASS z2ui6_cl_util_http DEFINITION PUBLIC.
  ...
  PUBLIC SECTION.
    ...
    TYPES:
      BEGIN OF ty_s_http_req,
        ...
        body     TYPE string,
        path     TYPE string,
        t_params TYPE z2ui6_cl_util=>ty_t_name_value,
    ...
    CLASS-METHODS factory
      ...
      RETURNING
        VALUE(result) TYPE REF TO z2ui6_cl_util_http.
...
CLASS z2ui6_cl_util_http IMPLEMENTATION.
...
*      ASSERT 1 = `NO_STATEFUL_FEATURE_IN_CLOUD_ERROR`.
  ...
  METHOD get_req_info.
    ...
    result-t_params = z2ui6_cl_util=>url_param_get_tab( get_header_field( `~request_uri` ) ).
