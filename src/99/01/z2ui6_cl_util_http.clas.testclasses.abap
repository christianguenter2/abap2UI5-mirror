CLASS ltcl_fake_request DEFINITION FINAL.
  PUBLIC SECTION.
    ...
    DATA mt_header TYPE z2ui6_cl_util=>ty_t_name_value.
...
CLASS ltcl_fake_response DEFINITION FINAL.
  PUBLIC SECTION.
    DATA mv_cdata          TYPE string.
    DATA mt_header         TYPE z2ui6_cl_util=>ty_t_name_value.
    DATA mt_cookie         TYPE z2ui6_cl_util=>ty_t_name_value.
...
CLASS ltcl_test DEFINITION FINAL
  ...
  PRIVATE SECTION.
    ...
    DATA mo_cut    TYPE REF TO z2ui6_cl_util_http.
...
CLASS ltcl_test IMPLEMENTATION.
  ...
  METHOD setup.
    ...
    mo_server = NEW #( ).
    mo_cut = z2ui6_cl_util_http=>factory( mo_server ).
  ...
  METHOD test_factory_cloud.
    ...
    DATA(lo_cut) = z2ui6_cl_util_http=>factory_cloud( req = NEW ltcl_fake_request( )
