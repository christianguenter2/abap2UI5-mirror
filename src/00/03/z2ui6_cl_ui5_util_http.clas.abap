CLASS z2ui6_cl_ui5_util_http DEFINITION PUBLIC.
  ...
  PUBLIC SECTION.
    ...
    TYPES:
      BEGIN OF ty_s_http_req,
        ...
        body     TYPE string,
        path     TYPE string,
        t_params TYPE z2ui6_cl_ui5_util_context=>ty_t_name_value,
    ...
    CLASS-METHODS factory
      ...
      RETURNING
        VALUE(result) TYPE REF TO z2ui6_cl_ui5_util_http.
...
CLASS z2ui6_cl_ui5_util_http IMPLEMENTATION.
  ...
  METHOD set_header_field.
    ...
    IF lv_n CA z2ui6_cl_ui5_util_context=>cv_char_util_cr_lf
        OR lv_v CA z2ui6_cl_ui5_util_context=>cv_char_util_cr_lf.
      DATA(lv_cr) = CONV string( z2ui6_cl_ui5_util_context=>cv_char_util_cr_lf(1) ).
      DATA(lv_lf) = CONV string( z2ui6_cl_ui5_util_context=>cv_char_util_cr_lf+1(1) ).
  ...
  METHOD get_req_info.
    ...
    result-t_params = z2ui6_cl_ui5_util_context=>url_param_get_tab( get_header_field( `~request_uri` ) ).
