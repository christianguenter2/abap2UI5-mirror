...
CLASS ltcl_test IMPLEMENTATION.
  ...
  METHOD test_bool_abap_true.
    ...
    cl_abap_unit_assert=>assert_equals(
        exp = `true`
        act = z2ui6_cl_ui5_util_context=>boolean_abap_2_json( abap_true ) ).
  ...
  METHOD test_bool_abap_false.
    ...
    cl_abap_unit_assert=>assert_equals(
        exp = `false`
        act = z2ui6_cl_ui5_util_context=>boolean_abap_2_json( abap_false ) ).
  ...
  METHOD test_bool_char_non_bool.
    ...
    cl_abap_unit_assert=>assert_equals(
        exp = `X`
        act = z2ui6_cl_ui5_util_context=>boolean_abap_2_json( lv_char ) ).
  ...
  METHOD test_bool_string_empty.
    ...
    cl_abap_unit_assert=>assert_equals(
        exp = ``
        act = z2ui6_cl_ui5_util_context=>boolean_abap_2_json( lv_string ) ).
  ...
  METHOD test_bool_string_literal.
    ...
    cl_abap_unit_assert=>assert_equals(
        exp = `true`
        act = z2ui6_cl_ui5_util_context=>boolean_abap_2_json( `true` ) ).
  ...
  METHOD test_bool_string_binding.
    ...
    cl_abap_unit_assert=>assert_equals(
        exp = `{path}`
        act = z2ui6_cl_ui5_util_context=>boolean_abap_2_json( `{path}` ) ).
  ...
  METHOD test_bool_check_by_data.
    ...
    cl_abap_unit_assert=>assert_true( z2ui6_cl_ui5_util_context=>boolean_check_by_data( abap_true ) ).
    cl_abap_unit_assert=>assert_true( z2ui6_cl_ui5_util_context=>boolean_check_by_data( abap_false ) ).
    cl_abap_unit_assert=>assert_false( z2ui6_cl_ui5_util_context=>boolean_check_by_data( lv_char ) ).
    cl_abap_unit_assert=>assert_false( z2ui6_cl_ui5_util_context=>boolean_check_by_data( `X` ) ).
    cl_abap_unit_assert=>assert_false( z2ui6_cl_ui5_util_context=>boolean_check_by_data( lv_int ) ).
  ...
  METHOD test_bool_cache_hit.
    ...
    z2ui6_cl_ui5_util_context=>boolean_abap_2_json( abap_true ).
  ...
  METHOD test_url_param_case.
    ...
    cl_abap_unit_assert=>assert_equals(
        exp = `MixedCase`
        act = z2ui6_cl_ui5_util_context=>url_param_get(
                  val = `app_start`
  ...
  METHOD test_url_param_no_phantom.
    ...
    cl_abap_unit_assert=>assert_initial(
        z2ui6_cl_ui5_util_context=>url_param_get_tab( `` ) ).

    cl_abap_unit_assert=>assert_equals(
        exp = 1
        act = lines( z2ui6_cl_ui5_util_context=>url_param_get_tab( `?a=1&` ) ) ).
  ...
  METHOD test_copy_ref_object.
    ...
    DATA(lo_obj) = NEW z2ui6_cl_ui5_util_context( ).
    cl_abap_unit_assert=>assert_false( z2ui6_cl_ui5_util_context=>rtti_check_ref_data( lo_obj ) ).

    DATA lv_text TYPE string VALUE `x`.
    DATA(lr_text) = REF #( lv_text ).
    cl_abap_unit_assert=>assert_true( z2ui6_cl_ui5_util_context=>rtti_check_ref_data( lr_text ) ).

    DATA(lr_copy) = z2ui6_cl_ui5_util_context=>conv_copy_ref_data( lo_obj ).
  ...
  METHOD test_c_trim_mixed.
    ...
    DATA(lv_tab) = z2ui6_cl_ui5_util_context=>cv_char_util_horizontal_tab.
    cl_abap_unit_assert=>assert_equals(
        exp = `x`
        act = z2ui6_cl_ui5_util_context=>c_trim( |{ lv_tab } { lv_tab } x { lv_tab } { lv_tab }| ) ).
    cl_abap_unit_assert=>assert_equals(
        exp = `a b`
        act = z2ui6_cl_ui5_util_context=>c_trim( `  a b  ` ) ).
  ...
  METHOD test_url_param_encoded.
    ...
    DATA(lt_params) = z2ui6_cl_ui5_util_context=>url_param_get_tab( `?a=x%26y&b=1%3D2` ).
    ...
    lt_params = z2ui6_cl_ui5_util_context=>url_param_get_tab(
  ...
  METHOD test_url_param_question.
    ...
    DATA(lt_params) = z2ui6_cl_ui5_util_context=>url_param_get_tab( `?app_start=zcl_x&title=why?` ).
...
CLASS ltcl_string IMPLEMENTATION.
  ...
  METHOD test_escape_html.
    ...
    cl_abap_unit_assert=>assert_equals(
        ...
        act = z2ui6_cl_ui5_util_context=>c_escape_html( `Tom & Jerry <b> said "it's fine"` ) ).

    cl_abap_unit_assert=>assert_equals(
        exp = `nothing to escape`
        act = z2ui6_cl_ui5_util_context=>c_escape_html( `nothing to escape` ) ).
  ...
  METHOD test_trim_spaces.
    ...
    cl_abap_unit_assert=>assert_equals( exp = `abc`
                                        act = z2ui6_cl_ui5_util_context=>c_trim( `   abc   ` ) ).
  ...
  METHOD test_trim_tabs.
    ...
    lv_val = z2ui6_cl_ui5_util_context=>cv_char_util_horizontal_tab
             && `abc`
             && z2ui6_cl_ui5_util_context=>cv_char_util_horizontal_tab.

    cl_abap_unit_assert=>assert_equals( exp = `abc`
                                        act = z2ui6_cl_ui5_util_context=>c_trim( lv_val ) ).
  ...
  METHOD test_trim_case.
    ...
    cl_abap_unit_assert=>assert_equals( exp = `ABC`
                                        act = z2ui6_cl_ui5_util_context=>c_trim_upper( ` aBc ` ) ).

    cl_abap_unit_assert=>assert_equals( exp = `abc`
                                        act = z2ui6_cl_ui5_util_context=>c_trim_lower( ` aBc ` ) ).
  ...
  METHOD test_bool_by_name.
    ...
    cl_abap_unit_assert=>assert_true( z2ui6_cl_ui5_util_context=>boolean_check_by_name( `ABAP_BOOL` ) ).
    cl_abap_unit_assert=>assert_true( z2ui6_cl_ui5_util_context=>boolean_check_by_name( `XFELD` ) ).
    cl_abap_unit_assert=>assert_true( z2ui6_cl_ui5_util_context=>boolean_check_by_name( `BOOLE_D` ) ).

    cl_abap_unit_assert=>assert_false( z2ui6_cl_ui5_util_context=>boolean_check_by_name( `abap_bool` ) ).
    cl_abap_unit_assert=>assert_false( z2ui6_cl_ui5_util_context=>boolean_check_by_name( `STRING` ) ).
    cl_abap_unit_assert=>assert_false( z2ui6_cl_ui5_util_context=>boolean_check_by_name( `` ) ).

  ENDMETHOD.

  METHOD test_url_create.

    DATA lt_params TYPE z2ui6_cl_ui5_util_context=>ty_t_name_value.
    ...
    cl_abap_unit_assert=>assert_equals(
        exp = `a=1&b=2`
        act = z2ui6_cl_ui5_util_context=>url_param_create_url( lt_params ) ).
  ...
  METHOD test_url_roundtrip.
    ...
    DATA(lt_params) = z2ui6_cl_ui5_util_context=>url_param_get_tab( `?a=1&b=2` ).
...
CLASS z2ui6_cl_ui5_util_context DEFINITION LOCAL FRIENDS ltcl_rtti.
...
CLASS ltcl_rtti IMPLEMENTATION.
  ...
  METHOD test_attri_include.
    ...
    DATA(lt_comp) = z2ui6_cl_ui5_util_context=>rtti_get_t_attri_by_any( ls_with_incl ).
  ...
  METHOD test_html_get_plain.
    ...
    cl_abap_unit_assert=>assert_equals(
        exp = `a b`
        act = z2ui6_cl_ui5_util_context=>html_get_plain( `<td>a</td><td>b</td>` ) ).
    cl_abap_unit_assert=>assert_equals(
        exp = `x < y & z`
        act = z2ui6_cl_ui5_util_context=>html_get_plain( `<p>x &lt; y &amp; z</p>` ) ).
    cl_abap_unit_assert=>assert_equals(
        exp = `a`
        act = z2ui6_cl_ui5_util_context=>html_get_plain( `a <b` ) ).
    cl_abap_unit_assert=>assert_equals(
        exp = `plain`
        act = z2ui6_cl_ui5_util_context=>html_get_plain( `plain` ) ).
  ...
  METHOD test_srtti_pair_roundtrip.
    ...
    z2ui6_cl_ui5_util_context=>xml_srtti_stringify_pair( EXPORTING data    = <tab>
    ...
    DATA(lr_back) = z2ui6_cl_ui5_util_context=>xml_srtti_parse_pair( iv_type = lv_type
                                                                     iv_data = lv_data ).
  ...
  METHOD test_printable_decfloat.
    ...
    cl_abap_unit_assert=>assert_true( z2ui6_cl_ui5_util_context=>rtti_check_printable( lv_d34 ) ).
  ...
  METHOD test_check_clike.
    ...
    cl_abap_unit_assert=>assert_true( z2ui6_cl_ui5_util_context=>rtti_check_clike( `abc` ) ).
    cl_abap_unit_assert=>assert_true( z2ui6_cl_ui5_util_context=>rtti_check_clike( lv_char ) ).
    " n, d and t are character-like too and must be accepted
    cl_abap_unit_assert=>assert_true( z2ui6_cl_ui5_util_context=>rtti_check_clike( lv_numc ) ).
    cl_abap_unit_assert=>assert_true( z2ui6_cl_ui5_util_context=>rtti_check_clike( lv_date ) ).

    cl_abap_unit_assert=>assert_false( z2ui6_cl_ui5_util_context=>rtti_check_clike( lv_int ) ).
    cl_abap_unit_assert=>assert_false( z2ui6_cl_ui5_util_context=>rtti_check_clike( ls_row ) ).
  ...
  METHOD test_check_table.
    ...
    cl_abap_unit_assert=>assert_true( z2ui6_cl_ui5_util_context=>rtti_check_table( lt_row ) ).

    cl_abap_unit_assert=>assert_false( z2ui6_cl_ui5_util_context=>rtti_check_table( ls_row ) ).
    cl_abap_unit_assert=>assert_false( z2ui6_cl_ui5_util_context=>rtti_check_table( `abc` ) ).
  ...
  METHOD test_check_structure.
    ...
    cl_abap_unit_assert=>assert_true( z2ui6_cl_ui5_util_context=>rtti_check_structure( ls_row ) ).

    cl_abap_unit_assert=>assert_false( z2ui6_cl_ui5_util_context=>rtti_check_structure( `abc` ) ).
    cl_abap_unit_assert=>assert_false( z2ui6_cl_ui5_util_context=>rtti_check_structure( lt_row ) ).
  ...
  METHOD test_check_ref_data.
    ...
    cl_abap_unit_assert=>assert_true( z2ui6_cl_ui5_util_context=>rtti_check_ref_data( lr_data ) ).

    cl_abap_unit_assert=>assert_false( z2ui6_cl_ui5_util_context=>rtti_check_ref_data( `abc` ) ).
  ...
  METHOD test_bound_not_init.
    ...
    cl_abap_unit_assert=>assert_false( z2ui6_cl_ui5_util_context=>check_bound_a_not_initial( lr_unbound ) ).
    cl_abap_unit_assert=>assert_false( z2ui6_cl_ui5_util_context=>check_bound_a_not_initial( lr_initial ) ).
    cl_abap_unit_assert=>assert_true( z2ui6_cl_ui5_util_context=>check_bound_a_not_initial( lr_filled ) ).
  ...
  METHOD test_struc_to_pairs.
    ...
    DATA(lt_pair) = z2ui6_cl_ui5_util_context=>itab_get_by_struc( ls_row ).
  ...
  METHOD test_scan_flag.
    ...
    DATA(lt_found) = z2ui6_cl_ui5_util_context=>scan_flag_prefix( val = ls_flags
                                                               prefix = `FLAG_` ).
...
CLASS ltcl_itab IMPLEMENTATION.
  ...
  METHOD test_filter_all_fields.
    ...
    z2ui6_cl_ui5_util_context=>itab_filter_by_val( EXPORTING val = `London`
                                                CHANGING  tab    = lt_row ).
  ...
  METHOD test_filter_ignore_case.
    ...
    z2ui6_cl_ui5_util_context=>itab_filter_by_val( EXPORTING val      = `ada`
  ...
  METHOD test_filter_no_match.
    ...
    z2ui6_cl_ui5_util_context=>itab_filter_by_val( EXPORTING val = `Nobody`
                                                CHANGING  tab    = lt_row ).
  ...
  METHOD test_corresponding.
    ...
    z2ui6_cl_ui5_util_context=>itab_corresponding( EXPORTING val = lt_row
...
CLASS ltcl_msg IMPLEMENTATION.
  ...
  METHOD test_msg_type_mapping.
    ...
    cl_abap_unit_assert=>assert_equals( exp = `Error`
                                        act = z2ui6_cl_ui5_util_context=>ui5_get_msg_type( `E` ) ).
    cl_abap_unit_assert=>assert_equals( exp = `Success`
                                        act = z2ui6_cl_ui5_util_context=>ui5_get_msg_type( `S` ) ).
    cl_abap_unit_assert=>assert_equals( exp = `Warning`
                                        act = z2ui6_cl_ui5_util_context=>ui5_get_msg_type( `W` ) ).
    cl_abap_unit_assert=>assert_equals( exp = `Information`
                                        act = z2ui6_cl_ui5_util_context=>ui5_get_msg_type( `I` ) ).
    cl_abap_unit_assert=>assert_equals( exp = `Information`
                                        act = z2ui6_cl_ui5_util_context=>ui5_get_msg_type( `X` ) ).
    cl_abap_unit_assert=>assert_equals( exp = `Information`
                                        act = z2ui6_cl_ui5_util_context=>ui5_get_msg_type( `` ) ).
  ...
  METHOD test_box_empty_skips.
    ...
    DATA lt_msg TYPE z2ui6_cl_ui5_util_context=>ty_t_msg.

    DATA(ls_box) = z2ui6_cl_ui5_util_context=>ui5_msg_box_format( lt_msg ).
  ...
  METHOD test_box_exception_object.
    ...
    DATA lx TYPE REF TO z2ui6_cx_ui5_util_error.
    TRY.
        RAISE EXCEPTION TYPE z2ui6_cx_ui5_util_error
          EXPORTING
            val = `Posting failed`.
      CATCH z2ui6_cx_ui5_util_error INTO lx ##NO_HANDLER.
    ENDTRY.

    DATA(ls_box) = z2ui6_cl_ui5_util_context=>ui5_msg_box_format( lx ).
  ...
  METHOD test_box_plain_object.
    ...
    DATA(ls_box) = z2ui6_cl_ui5_util_context=>ui5_msg_box_format( lo_carrier ).
  ...
  METHOD test_box_unbound_oref_skips.
    ...
    DATA(ls_box) = z2ui6_cl_ui5_util_context=>ui5_msg_box_format( lo_unbound ).
  ...
  METHOD test_box_no_msg_skips.
    ...
    DATA(ls_box) = z2ui6_cl_ui5_util_context=>ui5_msg_box_format( lt_row ).
  ...
  METHOD test_token_by_range.
    ...
    DATA lt_range TYPE z2ui6_cl_ui5_util_context=>ty_t_range.
    ...
    DATA(lt_token) = z2ui6_cl_ui5_util_context=>filter_get_token_t_by_range_t( lt_range ).
...
CLASS z2ui6_cl_ui5_util_context DEFINITION LOCAL FRIENDS ltcl_msg_rap.
...
CLASS ltcl_msg_rap IMPLEMENTATION.
  ...
  METHOD test_fail_text_known.
    ...
    cl_abap_unit_assert=>assert_equals( exp = `Entity not found`
                                        act = z2ui6_cl_ui5_util_context=>msg_get_rap_fail_text( 1 ) ).

    cl_abap_unit_assert=>assert_equals( exp = `Authorization failure`
                                        act = z2ui6_cl_ui5_util_context=>msg_get_rap_fail_text( 3 ) ).

    " 4 and 5 deliberately share one text - both are a concurrency conflict
    cl_abap_unit_assert=>assert_equals(
        exp = z2ui6_cl_ui5_util_context=>msg_get_rap_fail_text( 4 )
        act = z2ui6_cl_ui5_util_context=>msg_get_rap_fail_text( 5 ) ).
  ...
  METHOD test_fail_text_unknown.
    ...
    DATA(lv_text) = z2ui6_cl_ui5_util_context=>msg_get_rap_fail_text( 99 ).
  ...
  METHOD test_fail_text_all_causes.
    ...
    DO 12 TIMES.
      lv_cause = sy-index - 1.
      DATA(lv_text) = z2ui6_cl_ui5_util_context=>msg_get_rap_fail_text( lv_cause ).
  ...
  METHOD test_flatten_pairs.
    ...
    cl_abap_unit_assert=>assert_equals(
        ...
        act = z2ui6_cl_ui5_util_context=>msg_get_rap_flatten( ls_tky ) ).
  ...
  METHOD test_flatten_nested.
    ...
    cl_abap_unit_assert=>assert_equals(
        exp = `A=1, B=2, C=3`
        act = z2ui6_cl_ui5_util_context=>msg_get_rap_flatten( ls_nested ) ).
  ...
  METHOD test_flatten_not_a_struct.
    ...
    cl_abap_unit_assert=>assert_initial(
        z2ui6_cl_ui5_util_context=>msg_get_rap_flatten( lv_scalar ) ).
  ...
  METHOD test_is_rap_struct_plain.
    ...
    cl_abap_unit_assert=>assert_equals(
        exp = abap_false
        act = z2ui6_cl_ui5_util_context=>check_is_rap_struct( ls_plain ) ).
...
CLASS ltcl_data_box IMPLEMENTATION.
  ...
  METHOD test_text_plain.
    ...
    DATA(ls_box) = z2ui6_cl_ui5_util_context=>ui5_data_box_format( `Hello World` ).
  ...
  METHOD test_text_html.
    ...
    DATA(ls_box) = z2ui6_cl_ui5_util_context=>ui5_data_box_format(
  ...
  METHOD test_number.
    ...
    DATA(ls_box) = z2ui6_cl_ui5_util_context=>ui5_data_box_format( lv_int ).
  ...
  METHOD test_table.
    ...
    DATA(ls_box) = z2ui6_cl_ui5_util_context=>ui5_data_box_format( lt_row ).
  ...
  METHOD test_tree.
    ...
    DATA(ls_box) = z2ui6_cl_ui5_util_context=>ui5_data_box_format( ls_node ).
