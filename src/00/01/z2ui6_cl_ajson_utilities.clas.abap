  ...
  PUBLIC SECTION.
    ...
    CLASS-METHODS iterate_array
      IMPORTING
        ...
        iv_path TYPE string
      RETURNING
        VALUE(ri_iterator) TYPE REF TO z2ui6_if_ajson_iterator
      RAISING
        z2ui6_cx_ajson_error.
...
CLASS z2ui6_cl_ajson_utilities IMPLEMENTATION.
    ...
    DO.
      ...
      IF iv_keep_empty_arrays = abap_false.
        LOOP AT io_json->mt_json_tree INTO ls_json_tree
          WHERE type = z2ui6_if_ajson_types=>node_type-array AND children = 0. "#EC CI_SORTSEQ
      ...
      LOOP AT io_json->mt_json_tree INTO ls_json_tree
        WHERE type = z2ui6_if_ajson_types=>node_type-object AND children = 0. "#EC CI_SORTSEQ
  ...
  METHOD iterate_array.
    ...
    CREATE OBJECT ri_iterator TYPE lcl_node_iterator
      EXPORTING
        iv_node_type = z2ui6_if_ajson_types=>node_type-array
        ii_json = ii_json
        iv_path = iv_path.
  ...
  METHOD iterate_object.
    ...
    CREATE OBJECT ri_iterator TYPE lcl_node_iterator
      EXPORTING
        iv_node_type = z2ui6_if_ajson_types=>node_type-object
        ii_json = ii_json
        iv_path = iv_path.
