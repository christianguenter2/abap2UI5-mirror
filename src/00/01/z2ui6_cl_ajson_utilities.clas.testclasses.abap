...
CLASS ltcl_json_utils DEFINITION
  ...
  PRIVATE SECTION.
    ...
    METHODS iterate_array FOR TESTING RAISING z2ui6_cx_ajson_error.
    METHODS iterate_object FOR TESTING RAISING z2ui6_cx_ajson_error.
...
*      '        "row": 4,\n' && " array delete
  ...
  METHOD iterate_array.
    ...
    DATA li_iterator TYPE REF TO z2ui6_if_ajson_iterator.
    ...
    DATA li_json_item TYPE REF TO z2ui6_if_ajson.

    li_iterator = z2ui6_cl_ajson_utilities=>iterate_array(
      ii_json = li_cut
      iv_path = '/b' ).
    ...
    TRY.
        z2ui6_cl_ajson_utilities=>iterate_array(
        ii_json = li_cut
        iv_path = '/notexisting' ).
  ...
  METHOD iterate_object.
    ...
    li_iterator = z2ui6_cl_ajson_utilities=>iterate_object(
      ii_json = li_cut
      iv_path = '/b' ).
    WHILE li_iterator->has_next( ) = abap_true.
      li_json_item = li_iterator->next( ).
    ...
    TRY.
        z2ui6_cl_ajson_utilities=>iterate_object(
        ii_json = li_cut
        iv_path = '/notexisting' ).
        cl_abap_unit_assert=>fail( ).
      CATCH z2ui6_cx_ajson_error INTO lx.
