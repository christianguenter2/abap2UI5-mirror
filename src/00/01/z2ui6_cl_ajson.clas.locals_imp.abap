...
CLASS lcl_json_to_abap DEFINITION FINAL.
  PUBLIC SECTION.
    ...
    METHODS constructor
      IMPORTING
        ...
        !ii_refs_initiator TYPE REF TO z2ui6_if_ajson_refinit OPTIONAL.
  ...
  PRIVATE SECTION.
    ...
    DATA mi_refs_initiator TYPE REF TO z2ui6_if_ajson_refinit.
...
CLASS lcl_json_to_abap IMPLEMENTATION.
  ...
  METHOD get_data_ref.
    ...
    IF mi_refs_initiator IS INITIAL.
      z2ui6_cx_ajson_error=>raise( 'Missing ref initiator' ).
    ENDIF.

    ro_ref = mi_refs_initiator->get_data_ref( is_node ).

    IF ro_ref IS INITIAL.
      z2ui6_cx_ajson_error=>raise( 'Cannot use initial data ref' ).
    ENDIF.
