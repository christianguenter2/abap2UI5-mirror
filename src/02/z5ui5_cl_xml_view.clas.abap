...
CLASS z5ui5_cl_xml_view IMPLEMENTATION.
  ...
  METHOD core_custom_data.
    ...
    _generic( name   = `CustomData`
              ...
              t_prop = VALUE #( ( n = `value` v = value )
                                ( n = `key` v = key )
                                ( n = `writeToDom` v = z5ui5_cl_util=>boolean_abap_2_json( writetodom ) ) ) ).
  ...
  METHOD currency.
    result = _generic( name   = `Currency`
                       ...
                       t_prop = VALUE #( ( n = `value`        v = value )
                                         ...
                                         ( n = `useSymbol`    v = z5ui5_cl_util=>boolean_abap_2_json( usesymbol ) )
  ...
  METHOD grid.
    ...
    result = _generic(
                 ...
                 t_prop = VALUE #( ( n = `defaultSpan`    v = default_span )
                                   ( n = `class`          v = class )
                                   ( n = `containerQuery` v = z5ui5_cl_util=>boolean_abap_2_json( containerquery ) )
  ...
  METHOD grid_data.
    ...
    _generic( name   = `GridData`
              ...
              t_prop = VALUE #( ( n = `span`      v = span )
                                ( n = `linebreak` v = z5ui5_cl_util=>boolean_abap_2_json( linebreak ) )
                                ( n = `indentL`   v = indentl )
                                ( n = `indentM`   v = indentm ) ) ).
  ENDMETHOD.
  ...
  METHOD map_container.
    ...
    result = _generic( name   = `MapContainer`
                       ...
                       t_prop = VALUE #(
                           ...
                           ( n = `showHome`  v = z5ui5_cl_util=>boolean_abap_2_json( showHome )  )  ) ).
    ...
    result = _generic(
        ...
        t_prop = VALUE #(
            ...
            ( n = `enableAppointmentsDragAndDrop`
              v = z5ui5_cl_util=>boolean_abap_2_json( enableappointmentsdraganddrop ) )
            ( n = `text`                            v = text )
                        ) ).
...
*              ns     = `webc`
  ...
  METHOD shell_bar.
    result = _generic( name   = `ShellBar`
                       ...
                       t_prop = VALUE #(
                           ...
                           ( n = `showCopilot`  v = z5ui5_cl_util=>boolean_abap_2_json( showcopilot ) )
                           ( n = `showMenuButton`  v = z5ui5_cl_util=>boolean_abap_2_json( showmenubutton ) )
                           ( n = `showNavButton`  v = z5ui5_cl_util=>boolean_abap_2_json( shownavbutton ) )
                           ( n = `showNotifications`  v = z5ui5_cl_util=>boolean_abap_2_json( shownotifications ) )
                           ( n = `showProductSwitcher`  v = z5ui5_cl_util=>boolean_abap_2_json( showproductswitcher ) )
  ...
  METHOD toggle_button.
    ...
    _generic( name   = `ToggleButton`
              t_prop = VALUE #( ( n = `press`   v = press )
                                ...
                                ( n = `type`    v = type )
                                ( n = `class`   v = class )
                                ( n = `pressed` v = z5ui5_cl_util=>boolean_abap_2_json( pressed ) ) ) ).
  ENDMETHOD.
  ...
  METHOD xml_get.
    ...
    IF me = mo_root.
      ...
      DATA lt_prop TYPE HASHED TABLE OF z5ui5_if_types=>ty_s_name_value WITH UNIQUE KEY n.
      lt_prop = VALUE #(
          ( n = `z2ui5`             v = `z2ui5` )
...
*          ( n = `unified`           v = `sap.ui.unified` )
      ...
      LOOP AT mt_ns REFERENCE INTO DATA(lr_ns) WHERE     table_line IS NOT INITIAL
        ...
        TRY.
          ...
          CATCH cx_root.
            z5ui5_cl_util=>x_raise( |XML_VIEW_ERROR_NO_NAMESPACE_FOUND_FOR:  { lr_ns->* }| ).
        ENDTRY.
      ENDLOOP.
  ...
  METHOD field.
    result = _generic(
        ...
        t_prop = VALUE #( ( n = `id`        v = id )
                          ...
                          ( n = `showEmptyIndicator`  v = z5ui5_cl_util=>boolean_abap_2_json( showemptyindicator ) ) ) ).
  ENDMETHOD.
  ...
  METHOD control_configuration.
    ...
    _generic( name   = `ControlConfiguration`
                        ...
                        t_prop = VALUE #( ( n = `id`  v = id )
                                          ( n = `key`  v = key )
                                          ( n = `visibleInAdvancedArea`  v = z5ui5_cl_util=>boolean_abap_2_json( visibleInAdvancedArea ) )
                                          ( n = `preventInitialDataFetchInValueHelpDialog`  v = z5ui5_cl_util=>boolean_abap_2_json( prevInitDataFetchInValHelpDia ) )
                                          ) ).
  ...
  METHOD smart_table.
    ...
    result = _generic( name   = `SmartTable`
                        ...
                        ( n = `smartFilterId`  v = smartFilterId )
                                          ...
                                          ( n = `entitySet`  v = entitySet )
                                          ( n = `useVariantManagement`  v = z5ui5_cl_util=>boolean_abap_2_json( useVariantManagement ) )
                                          ( n = `useExportToExcel`  v = z5ui5_cl_util=>boolean_abap_2_json( useExportToExcel ) )
                                          ( n = `useTablePersonalisation`  v = z5ui5_cl_util=>boolean_abap_2_json( useTablePersonalisation ) )
                                          ( n = `header`  v = header )
                                          ( n = `showRowCount`  v =  z5ui5_cl_util=>boolean_abap_2_json( showRowCount ) )
                                          ( n = `enableExport`  v =  z5ui5_cl_util=>boolean_abap_2_json( enableExport ) )
                                          ( n = `enableAutoBinding`  v =  z5ui5_cl_util=>boolean_abap_2_json( enableAutoBinding ) )
                                          ) ).
