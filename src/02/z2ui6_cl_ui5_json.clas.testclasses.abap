...
CLASS ltcl_test_json IMPLEMENTATION.
  ...
  METHOD test_get_string.
    ...
    DATA(lo_json) = z2ui6_cl_ui5_json=>factory(
  ...
  METHOD test_get_integer.
    ...
    DATA(lo_json) = z2ui6_cl_ui5_json=>factory( `{"qty":7,"label":"7"}` ).
  ...
  METHOD test_get_integer_overflow.
    ...
    DATA(lo_json) = z2ui6_cl_ui5_json=>factory( `{"big":99999999999,"n":7}` ).
  ...
  METHOD test_exists.
    ...
    DATA(lo_json) = z2ui6_cl_ui5_json=>factory( `{"name":"","s":{"deep":1}}` ).
  ...
  METHOD test_members_object.
    ...
    DATA(lo_json) = z2ui6_cl_ui5_json=>factory( `{"b":1,"a":2}` ).
  ...
  METHOD test_missing_path.
    ...
    DATA(lo_json) = z2ui6_cl_ui5_json=>factory( `{"a":1}` ).
  ...
  METHOD test_invalid_json.
    ...
    TRY.
        z2ui6_cl_ui5_json=>factory( `not json at all {{{` ).
