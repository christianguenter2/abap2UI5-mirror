CLASS z2ui6_cl_ui5_http_handler DEFINITION PUBLIC.
  ...
  PUBLIC SECTION.
    ...
    TYPES:
      BEGIN OF ty_s_http_req,
        ...
        body     TYPE string,
        path     TYPE string,
        t_params TYPE z2ui6_if_client=>ty_t_name_value,
    ...
    CLASS-METHODS factory_cloud
      ...
      RETURNING
        VALUE(result) TYPE REF TO z2ui6_cl_ui5_http_handler.
  ...
  PROTECTED SECTION.
    CLASS-DATA so_sticky_handler TYPE REF TO z2ui6_cl_ui5_handler.

    DATA mo_server TYPE REF TO z2ui6_cl_ui5_util_http.
  ...
  PRIVATE SECTION.
    ...
    CLASS-DATA ss_config_http_get     TYPE z2ui6_if_ui5_exit=>ty_s_http_config.
    CLASS-DATA sv_config_http_get_set TYPE abap_bool.

    CLASS-METHODS config_http_get
      RETURNING
        VALUE(result) TYPE z2ui6_if_ui5_exit=>ty_s_http_config.
    ...
    METHODS check_csrf_rejected_request
      IMPORTING
        is_config     TYPE z2ui6_if_ui5_exit=>ty_s_http_config_post
      RETURNING
        VALUE(result) TYPE abap_bool.
...
CLASS z2ui6_cl_ui5_http_handler IMPLEMENTATION.
  ...
  METHOD main.
    ...
    TRY.
        ...
        z2ui6_cl_ui5_user_exit=>init_context( ms_req ).
        ...
        CASE ms_req-method.
          WHEN `HEAD` OR `POST`.
            ...
            " own exit.
            DATA(ls_config_post) = VALUE z2ui6_if_ui5_exit=>ty_s_http_config_post( ).
            z2ui6_cl_ui5_user_exit=>get_instance( )->set_config_http_post( CHANGING cs_config = ls_config_post ).
  ...
  METHOD _attr_escape.
    ...
    result = z2ui6_cl_ui5_util_context=>c_escape_html( result ).
  ...
  METHOD factory.
    ...
    IF server IS BOUND.
      result = NEW #( ).
      result->mo_server = z2ui6_cl_ui5_util_http=>factory( server ).
  ...
  METHOD factory_cloud.
    ...
    result = NEW #( ).
    result->mo_server = z2ui6_cl_ui5_util_http=>factory_cloud( req = req
                                                               res = res ).
  ...
  METHOD config_http_get.
    ...
    IF sv_config_http_get_set = abap_false.
      z2ui6_cl_ui5_user_exit=>get_instance( )->set_config_http_get( CHANGING cs_config = ss_config_http_get ).
  ...
  METHOD _http_get.
    ...
    DATA(lv_style_css) = COND string( WHEN ls_config-styles_css IS INITIAL
                                      THEN z2ui6_cl_ui5f_style_css=>get( )
    ...
    DATA(lv_preload) = z2ui6_cl_ui5f_preload=>get( styles_css = lv_style_css
  ...
  METHOD _get_etag.
    ...
    TRY.
        lv_xstr = z2ui6_cl_ui5_util_context=>conv_get_xstring_by_string( val ).
      CATCH cx_root.
        RETURN.
    ENDTRY.
    ...
    result = |"{ z2ui6_if_app=>version }-{ z2ui6_cl_ui5f_preload=>build_hash }-{ lv_len }-{ lv_h1 }-{ lv_h2 }-{ lv_h3 }"|.
  ...
  METHOD _http_post.
    ...
    IF so_sticky_handler IS NOT BOUND.
      DATA(lo_post) = NEW z2ui6_cl_ui5_handler( is_req-body ).
    ELSE.
  ...
  METHOD _main.
    ...
    TRY.
        z2ui6_cl_ui5_user_exit=>init_context( is_req ).
  ...
  METHOD _error_body.
    ...
    DATA(lv_nl) = z2ui6_cl_ui5_util_context=>cv_char_util_newline.

    result = |abap2UI5 { z2ui6_if_app=>version } - unhandled exception in a { method } request| &&
             lv_nl && lv_nl && z2ui6_cx_ui5_util_error=>get_text_full( val ).
