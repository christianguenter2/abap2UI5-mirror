...
CLASS ltcl_builder IMPLEMENTATION.
  ...
  METHOD trailing_end_is_optional.
    ...
    DATA(closed) = z2ui6_cl_ui5_view_builder=>factory( ).
    closed->ele( `Page`
        )->ele( `Panel`
            )->ele( `Title`
            )->end(
    ...
    DATA(open) = z2ui6_cl_ui5_view_builder=>factory( ).
    open->ele( `Page`
        )->ele( `Panel`
            )->ele( `Title` ).
  ...
  METHOD escape_whitespace_chars.
    ...
    view->tag( `Text`
                ...
                v = |line1{ z2ui6_cl_ui5_util_context=>cv_char_util_newline }line2{ z2ui6_cl_ui5_util_context=>cv_char_util_horizontal_tab }end| ).
  ...
  METHOD escape_control_chars.
    ...
    DATA(lv_ctrl) = z2ui6_cl_ui5_util_context=>conv_get_string_by_xstring( CONV xstring( `0C1E` ) ).
    DATA(view) = z2ui6_cl_ui5_view_builder=>factory( ).

    view->tag( `Text`
        )->a( n   = `text`
                v = |a{ lv_ctrl }b{ z2ui6_cl_ui5_util_context=>cv_char_util_horizontal_tab }c| ).
  ...
  METHOD escape_literal_braces.
    ...
    cl_abap_unit_assert=>assert_equals(
      act = z2ui6_cl_ui5_view_builder=>escape_literal( `a {/PATH} b` )
      exp = `a \{/PATH\} b` ).

    cl_abap_unit_assert=>assert_equals(
      act = z2ui6_cl_ui5_view_builder=>escape_literal( `{= 1 > 0 }\x` )
      exp = `\{= 1 > 0 \}\\x` ).
  ...
  METHOD escape_literal_passthrough.
    ...
    cl_abap_unit_assert=>assert_equals(
      act = z2ui6_cl_ui5_view_builder=>escape_literal( `a plain text` )
      exp = `a plain text` ).

    cl_abap_unit_assert=>assert_equals(
      act = z2ui6_cl_ui5_view_builder=>escape_literal( `` )
      exp = `` ).
  ...
  METHOD escape_literal_backslash.
    ...
    cl_abap_unit_assert=>assert_equals(
      act = z2ui6_cl_ui5_view_builder=>escape_literal( `C:\temp\file` )
      exp = `C:\\temp\\file` ).

    cl_abap_unit_assert=>assert_equals(
      act = z2ui6_cl_ui5_view_builder=>escape_literal( `\\server\share` )
      exp = `\\\\server\\share` ).
  ...
  METHOD misuse_raises_not_dumps.
    ...
    TRY.
      ...
      CATCH z2ui6_cx_ui5_util_error INTO DATA(lx_root).
    ...
    TRY.
      ...
      CATCH z2ui6_cx_ui5_util_error INTO DATA(lx_none).
    ...
    TRY.
      ...
      CATCH z2ui6_cx_ui5_util_error INTO DATA(lx_both).
    ...
    TRY.
      ...
      CATCH z2ui6_cx_ui5_util_error INTO DATA(lx_v_t).
    ...
    TRY.
      ...
      CATCH z2ui6_cx_ui5_util_error INTO DATA(lx_b_t).
    ...
    TRY.
      ...
      CATCH z2ui6_cx_ui5_util_error INTO DATA(lx_dup).
  ...
  METHOD end_past_root_raises.
    ...
    TRY.
      ...
      CATCH z2ui6_cx_ui5_util_error INTO DATA(lx_end).
