CLASS z5ui5_cl_pop_to_confirm DEFINITION
  PUBLIC FINAL
  CREATE PUBLIC.
  ...
  PUBLIC SECTION.
    ...
    CLASS-METHODS factory
      ...
      RETURNING
        VALUE(r_result)       TYPE REF TO z5ui5_cl_pop_to_confirm.
...
CLASS z5ui5_cl_pop_to_confirm IMPLEMENTATION.
  METHOD result.
  ...
  METHOD view_display.
    ...
    DATA(popup) = z5ui5_cl_xml_view=>factory_popup( )->dialog( title      = title
                                                               icon       = icon
