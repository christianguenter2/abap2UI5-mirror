CLASS z5ui5_cl_pop_get_range DEFINITION
  PUBLIC FINAL
  CREATE PUBLIC.
  ...
  PUBLIC SECTION.
    ...
    CLASS-METHODS factory
      ...
      RETURNING
        VALUE(r_result) TYPE REF TO z5ui5_cl_pop_get_range.
...
CLASS z5ui5_cl_pop_get_range IMPLEMENTATION.
  METHOD factory.

    r_result = NEW #( ).

    z5ui5_cl_util=>itab_corresponding( EXPORTING val = t_range
