CLASS z5ui5_cl_pop_layout DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
  ...
  PUBLIC SECTION.
    ...
    CLASS-METHODS factory
      ...
      RETURNING
        VALUE(result)    TYPE REF TO z5ui5_cl_pop_layout.
...
CLASS z5ui5_cl_pop_layout IMPLEMENTATION.
  ...
  METHOD init_layout.
    ...
    DATA(t_comp)   = z5ui5_cl_util=>rtti_get_t_attri_by_any( tab ).
...
* postionen lesen und loeschen
  ...
  METHOD z5ui5_if_app~main.
    ...
    IF client->get( )-check_on_navigated = abap_true.
      ...
      TRY.
          DATA(app) = CAST z5ui5_cl_pop_layout( client->get_app( client->get( )-s_draft-id_prev_app ) ).
