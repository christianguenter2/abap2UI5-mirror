...
CLASS z2ui6_cl_ui5_json DEFINITION PUBLIC FINAL CREATE PRIVATE.
  ...
  PUBLIC SECTION.
    ...
    CLASS-METHODS factory
      IMPORTING
        val           TYPE clike
      RETURNING
        VALUE(result) TYPE REF TO z2ui6_cl_ui5_json.
...
CLASS z2ui6_cl_ui5_json IMPLEMENTATION.

  METHOD factory.

    TRY.
        result = NEW #( ).
        result->mi_json = z2ui6_cl_ajson=>parse( val ).
  ...
  METHOD get_integer.
    ...
    TRY.
        IF mi_json->get_node_type( lv_path ) <> z2ui6_if_ajson_types=>node_type-number.
          RETURN.
        ENDIF.
  ...
  METHOD get_boolean.
    ...
    IF mi_json->get_node_type( lv_path ) = z2ui6_if_ajson_types=>node_type-boolean.
