...
CLASS z2ui6_cl_ui5_view_builder DEFINITION PUBLIC FINAL CREATE PRIVATE.
  ...
  PROTECTED SECTION.
    TYPES ty_t_node TYPE STANDARD TABLE OF REF TO z2ui6_cl_ui5_view_builder WITH EMPTY KEY.
    TYPES:
    ...
    DATA parent  TYPE REF TO z2ui6_cl_ui5_view_builder.
    DATA root    TYPE REF TO z2ui6_cl_ui5_view_builder.
...
CLASS z2ui6_cl_ui5_view_builder IMPLEMENTATION.
  ...
  METHOD render_into.
    ...
    DATA child TYPE REF TO z2ui6_cl_ui5_view_builder.
  ...
  METHOD xml_escape.
    ...
    IF gv_escape_specials IS INITIAL.
      ...
      gv_escape_controls = z2ui6_cl_ui5_util_context=>conv_get_string_by_xstring(
          CONV xstring( `0102030405060708` && `0B0C` && `0E0F101112131415161718191A1B1C1D1E1F` ) ).
      gv_escape_specials = `&<>"`
          && z2ui6_cl_ui5_util_context=>cv_char_util_newline
          && z2ui6_cl_ui5_util_context=>cv_char_util_cr_lf(1)
    ...
    result = replace( val  = result
                      ...
                      occ  = 0 ).
    result = replace( val  = result
                      sub  = z2ui6_cl_ui5_util_context=>cv_char_util_horizontal_tab
                      with = `&#x9;`
                      occ  = 0 ).
