CLASS z5ui5_cl_pop_itab_json_dl DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
  ...
  PUBLIC SECTION.
    ...
    CLASS-METHODS factory
      ...
      RETURNING
        VALUE(r_result)       TYPE REF TO z5ui5_cl_pop_itab_json_dl.
...
CLASS z5ui5_cl_pop_itab_json_dl IMPLEMENTATION.
  ...
  METHOD z5ui5_if_app~main.
    ...
    TRY.
        ...
        IF z5ui5_cl_util=>rtti_check_class_exists( `z2ui5_dbt_cl_app_03` ) = abap_false.
          ...
          client->nav_app_leave( z5ui5_cl_pop_error=>factory( lx ) ).
      ...
      CATCH cx_root INTO DATA(x).
        client->nav_app_leave( z5ui5_cl_pop_to_inform=>factory( x->get_text( ) ) ).
    ENDTRY.
  ENDMETHOD.
ENDCLASS.
