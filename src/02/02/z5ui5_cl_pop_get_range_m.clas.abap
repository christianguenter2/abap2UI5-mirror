CLASS z5ui5_cl_pop_get_range_m DEFINITION
  PUBLIC FINAL
  CREATE PUBLIC.
  ...
  PUBLIC SECTION.
    ...
    CLASS-METHODS factory
      ...
      RETURNING
        VALUE(r_result) TYPE REF TO z5ui5_cl_pop_get_range_m.
...
CLASS z5ui5_cl_pop_get_range_m IMPLEMENTATION.
...
*        )->toolbar_spacer(
  ...
  METHOD z5ui5_if_app~main.
    ...
    IF client->get( )-check_on_navigated = abap_true.
      ...
      DATA(lo_popup) = CAST z5ui5_cl_pop_get_range( client->get_app( client->get( )-s_draft-id_prev_app ) ).
    ...
    CASE client->get( )-event.
      ...
      WHEN 'LIST_OPEN'.
        ...
        client->nav_app_call( z5ui5_cl_pop_get_range=>factory( ls_sql-t_range ) ).
