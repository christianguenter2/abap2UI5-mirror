CLASS z5ui5_cl_pop_transport DEFINITION
  PUBLIC FINAL
  CREATE PUBLIC.
  ...
  PUBLIC SECTION.
    ...
    CLASS-METHODS factory
      RETURNING
        VALUE(result) TYPE REF TO z5ui5_cl_pop_transport.
  ...
  PROTECTED SECTION.
    ...
    CLASS-METHODS get_e071k_tabkey
      IMPORTING
        !line            TYPE any
        dfies            TYPE z5ui5_cl_stmpncfctn_api=>ty_t_dfies
      RETURNING
...
CLASS z5ui5_cl_pop_transport IMPLEMENTATION.
  ...
  METHOD on_init.
    ...
    IF z5ui5_cl_util_api=>rtti_check_lang_version_cloud( ) = abap_true.
      get_tr_cloud( ).
    ELSE.
      get_tr_onprem( ).
    ENDIF.
  ...
  METHOD add_DATA_to_tranport.
    ...
    IF z5ui5_cl_util_api=>rtti_check_lang_version_cloud( ) = abap_false.
...
*    ENDLOOP.
  ...
  METHOD get_tr_onprem.
    ...
    TRY.
        DATA(t_comp) = z5ui5_cl_util_api=>rtti_get_t_attri_by_table_name( table_name ).
  ...
  METHOD set_e071k.
    ...
    DATA(t_comp) = z5ui5_cl_util_api=>rtti_get_t_attri_by_table_name( 'E071K' ).
    ...
    DATA(dfies) = z5ui5_cl_util_api=>rtti_get_t_dfies_by_table_name( iv_tabname ).
...
*                                          structure = <s_e071k> ).                                         )
  ...
  METHOD set_e071.
    ...
    DATA(t_comp) = z5ui5_cl_util_api=>rtti_get_t_attri_by_table_name( 'E071' ).
