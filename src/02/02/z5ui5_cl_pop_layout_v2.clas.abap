CLASS z5ui5_cl_pop_layout_v2 DEFINITION
  PUBLIC FINAL
  CREATE PUBLIC.
  ...
  PUBLIC SECTION.
    ...
    TYPES ty_s_Head TYPE z5ui5_t003.
    ...
    CLASS-METHODS on_event_layout
      ...
      RETURNING
        VALUE(result) TYPE REF TO z5ui5_if_client.

    CLASS-METHODS render_layout_function
      IMPORTING
        !xml          TYPE REF TO z5ui5_cl_xml_view
        !client       TYPE REF TO z5ui5_if_client
      RETURNING
    ...
    CLASS-METHODS factory
      ...
      RETURNING
        VALUE(result) TYPE REF TO z5ui5_cl_pop_layout_v2.
  ...
  PROTECTED SECTION.
    ...
    METHODS check_width_unit
      IMPORTING
        !width        TYPE z5ui5_t004-width
      RETURNING
        VALUE(result) TYPE z5ui5_t004-width.
...
CLASS z5ui5_cl_pop_layout_v2 IMPLEMENTATION.
...
*                                  stretch      = abap_true
    ...
    DATA(lt_comp) = z5ui5_cl_util=>rtti_get_t_attri_by_any( ms_layout-t_layout ).
  ...
  METHOD save_layout.
    ...
    DATA line      TYPE z5ui5_t004.
    DATA Positions TYPE STANDARD TABLE OF z5ui5_t004 WITH EMPTY KEY.
    ...
    DATA(Head) = VALUE z5ui5_t003( guid     = ms_layout-s_head-guid
                                   layout   = mv_layout
    ...
    IF sy-subrc = 0.
      ...
      IF t_heads IS NOT INITIAL.
        ...
        SELECT mandt, guid, pos_guid FROM z5ui5_t004
        ...
        IF sy-subrc = 0.
          ...
          DELETE z5ui5_t004 FROM TABLE @t_del.
    ...
    MODIFY z5ui5_t003 FROM @Head.
    IF sy-subrc = 0.

      MODIFY z5ui5_t004 FROM TABLE @Positions.
  ...
  METHOD init_layout.
    ...
    DATA(t_comp) = z5ui5_cl_util_api=>rtti_get_t_attri_by_any( data ).
  ...
  METHOD delete_selected_layout.
    ...
    DELETE FROM z5ui5_t003 WHERE guid = @Head-guid.

    DELETE FROM z5ui5_t004 WHERE guid = @Head-guid.
  ...
  METHOD set_text.
    ...
    IF layout-alternative_text IS INITIAL.
      result = z5ui5_cl_stmpncfctn_api=>rtti_get_data_element_texts( CONV #( layout-rollname ) )-long.
    ELSE.
      result = z5ui5_cl_stmpncfctn_api=>rtti_get_data_element_texts( CONV #( layout-alternative_text ) )-long.
    ENDIF.
  ...
  METHOD on_event_subcoloumns.
    ...
    CASE client->get( )-event.
      ...
      WHEN `SUBCOLUMN_ADD`.
        INSERT VALUE #( key = z5ui5_cl_util=>uuid_get_c32( ) ) INTO TABLE mt_sub_cols.
        client->popup_model_update( ).
  ...
  METHOD set_sub_columns.
    ...
    LOOP AT result REFERENCE INTO DATA(line) WHERE subcolumn IS NOT INITIAL.
      ...
      line->t_sub_col = VALUE #( FOR t IN tab
                                 ( key = z5ui5_cl_util=>uuid_get_c32( ) fname = t ) ).
