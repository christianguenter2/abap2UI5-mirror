CLASS z5ui5_cl_pop_f4_help DEFINITION
  PUBLIC FINAL
  CREATE PUBLIC.
  ...
  PUBLIC SECTION.
    ...
    DATA ms_layout       TYPE z5ui5_cl_pop_layout_v2=>ty_s_layout.
    ...
    DATA mt_dfies        TYPE z5ui5_cl_util_api=>ty_t_dfies.
    ...
    CLASS-METHODS factory
      IMPORTING
        ...
        i_value       TYPE string
      RETURNING
        VALUE(result) TYPE REF TO z5ui5_cl_pop_f4_help.
...
CLASS z5ui5_cl_pop_f4_help IMPLEMENTATION.
  ...
  METHOD create_objects.
    ...
    TRY.
        ...
        APPEND LINES OF z5ui5_cl_util_api=>rtti_get_t_attri_by_table_name( mv_check_tab  ) TO comp.
  ...
  METHOD render_view.
    ...
    headder = z5ui5_cl_pop_layout_v2=>render_layout_function( xml    = headder
                                                              client = client ).
  ...
  METHOD on_event.
    ...
    CASE client->get( )-event.
      ...
      WHEN OTHERS.
        ...
        client = z5ui5_cl_pop_layout_v2=>on_event_layout( client = client
                                                          layout = ms_layout ).
  ...
  METHOD get_txt.
    ...
    result = z5ui5_cl_stmpncfctn_api=>rtti_get_data_element_texts( roll )-long.

  ENDMETHOD.

  METHOD get_dfies.

    DATA(t_dfies) = z5ui5_cl_util_api=>rtti_get_t_dfies_by_table_name( mv_table ).
    ...
    mt_dfies = z5ui5_cl_util_api=>rtti_get_t_dfies_by_table_name( CONV #( dfies->checktable ) ).
    "
  ...
  METHOD on_after_layout.
    ...
    TRY.
        " War es das Layout?
        DATA(app) = CAST z5ui5_cl_pop_layout_v2( client->get_app( client->get( )-s_draft-id_prev_app ) ).
  ...
  METHOD get_layout.
    ...
    ms_layout = z5ui5_cl_pop_layout_v2=>init_layout( control  = z5ui5_cl_pop_layout_v2=>m_table
                                                     data     = mt_data
                                                     handle01 = CONV #( class )
