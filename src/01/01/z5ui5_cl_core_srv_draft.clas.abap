CLASS z5ui5_cl_core_srv_draft DEFINITION
  PUBLIC FINAL
  CREATE PUBLIC.
...
CLASS z5ui5_cl_core_srv_draft IMPLEMENTATION.
  METHOD cleanup.

    DATA(lv_four_hours_ago) = z5ui5_cl_util=>time_substract_seconds( time    = z5ui5_cl_util=>time_get_timestampl( )
                                                                     seconds = 60 * 60 * 4 ).
  ...
  METHOD create.
    ...
    DATA(ls_db) = VALUE z5ui5_if_core_types=>ty_s_db( id                = draft-id
                                                      id_prev           = draft-id_prev
                                                      id_prev_app       = draft-id_prev_app
                                                      id_prev_app_stack = draft-id_prev_app_stack
                                                      uname             = z5ui5_cl_util=>context_get_user_tech( )
