...
CLASS ltcl_test IMPLEMENTATION.
  METHOD test_create.
    ...
    DATA lo_draft TYPE REF TO z2ui6_cl_ui5_srv_draft.
    DATA ls_db TYPE z2ui6_t_01.
    lo_draft = NEW #( ).
  ...
  METHOD test_read_info.
    ...
    DATA lo_draft TYPE REF TO z2ui6_cl_ui5_srv_draft.
    DATA ls_info TYPE z2ui6_cl_ui5_srv_draft=>ty_s_draft.
    lo_draft = NEW #( ).
  ...
  METHOD test_buffer.
    ...
    DATA lo_draft TYPE REF TO z2ui6_cl_ui5_srv_draft.
    DATA ls_first TYPE z2ui6_t_01.
    DATA ls_second TYPE z2ui6_t_01.
    lo_draft = NEW #( ).
    DATA(ls_draft) = VALUE z2ui6_cl_ui5_srv_draft=>ty_s_draft( id = `TEST_BUF` ).
  ...
  METHOD test_owner_binding.
    ...
    MODIFY z2ui6_t_01 FROM @ls_db ##SUBRC_OK.
    COMMIT WORK.
  ...
  METHOD test_owner_binding_write.
    ...
    DATA ls_draft TYPE z2ui6_cl_ui5_srv_draft=>ty_s_draft.
    ...
    SELECT SINGLE data FROM z2ui6_t_01
  ...
  METHOD test_count_total.
    ...
    DELETE FROM z2ui6_t_01 WHERE id = @( `TEST_COUNT_FOREIGN` ) ##SUBRC_OK.
    COMMIT WORK.
