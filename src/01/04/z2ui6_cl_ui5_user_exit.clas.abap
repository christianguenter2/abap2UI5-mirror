CLASS z2ui6_cl_ui5_user_exit DEFINITION PUBLIC.
  ...
  PUBLIC SECTION.
    ...
    CLASS-METHODS init_context
      IMPORTING
        http_info TYPE z2ui6_cl_ui5_http_handler=>ty_s_http_req.

    CLASS-METHODS get_instance
      RETURNING
        VALUE(result) TYPE REF TO z2ui6_if_ui5_exit.
  ...
  PROTECTED SECTION.
    CLASS-DATA gi_me            TYPE REF TO z2ui6_if_ui5_exit.
    CLASS-DATA gi_user_exit     TYPE REF TO z2ui6_if_ui5_exit.
    " the same exit found under the superseded interface - only one of the two
    " is ever bound, see exit_instantiate
    CLASS-DATA gi_user_exit_dep TYPE REF TO z2ui6_if_exit.
    CLASS-DATA gs_context       TYPE z2ui6_if_ui5_exit=>ty_s_http_context.
...
CLASS z2ui6_cl_ui5_user_exit IMPLEMENTATION.
  ...
  METHOD get_instance.
    ...
    gi_me = NEW z2ui6_cl_ui5_user_exit( ).
  ...
  METHOD get_user_exit_class.
    ...
    TRY.
        ...
        DATA(exit_classes) = z2ui6_cl_ui5_util_context=>rtti_get_classes_impl_intf( `Z2UI5_IF_UI5_EXIT` ).
        ...
        IF lines( exit_classes ) = 0.
          exit_classes = z2ui6_cl_ui5_util_context=>rtti_get_classes_impl_intf( `Z2UI5_IF_EXIT` ).
        ENDIF.
  ...
  METHOD init_context.
    ...
    gs_context-app_start = z2ui6_cl_ui5_util_context=>c_trim_upper(
