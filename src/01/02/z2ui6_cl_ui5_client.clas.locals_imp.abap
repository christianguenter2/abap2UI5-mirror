...
CLASS lcl_node_value IMPLEMENTATION.
  ...
  METHOD check_initial.
    ...
    IF is_node-type = z2ui6_if_ajson_types=>node_type-number.
...
CLASS lcl_empty_filter_keep_rows IMPLEMENTATION.
  ...
  METHOD z2ui6_if_ajson_filter~keep_node.
    ...
    IF iv_visit = z2ui6_if_ajson_filter=>visit_type-value.
...
CLASS lcl_and_filter DEFINITION FINAL.
  ...
  PUBLIC SECTION.
    ...
    METHODS constructor
      IMPORTING
        ii_first  TYPE REF TO z2ui6_if_ajson_filter
        ii_second TYPE REF TO z2ui6_if_ajson_filter.

  PROTECTED SECTION.
  PRIVATE SECTION.
    DATA mi_first  TYPE REF TO z2ui6_if_ajson_filter.
    DATA mi_second TYPE REF TO z2ui6_if_ajson_filter.
