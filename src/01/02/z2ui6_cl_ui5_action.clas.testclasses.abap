...
CLASS z2ui6_cl_ui5_action DEFINITION LOCAL FRIENDS ltcl_test.
...
CLASS ltcl_test IMPLEMENTATION.
  ...
  METHOD test_instantiation.
    ...
    DATA lo_action TYPE REF TO z2ui6_cl_ui5_action.
    lo_http = NEW #( val = `` ).
  ...
  METHOD test_system_startup.
    DATA lo_http TYPE REF TO z2ui6_cl_ui5_handler.
    DATA lo_action TYPE REF TO z2ui6_cl_ui5_action.
    DATA lo_result TYPE REF TO z2ui6_cl_ui5_action.
  ...
  METHOD test_app_start_safe.
    ...
    cl_abap_unit_assert=>assert_equals(
      ...
      act = z2ui6_cl_ui5_action=>app_start_safe( `Z2UI5_CL_UI5_APP_HI_WORLD` ) ).
    cl_abap_unit_assert=>assert_equals(
      exp = `/ns/zcl_appscriptalert1/script`
      act = z2ui6_cl_ui5_action=>app_start_safe( `/ns/zcl_app<script>alert(1)</script>` ) ).
    cl_abap_unit_assert=>assert_initial( z2ui6_cl_ui5_action=>app_start_safe( `` ) ).
  ...
  METHOD test_stack_call.
    ...
    DATA lo_action TYPE REF TO z2ui6_cl_ui5_action.
    DATA lo_result TYPE REF TO z2ui6_cl_ui5_action.
    DATA lo_chained TYPE REF TO z2ui6_cl_ui5_action.
    ...
    lo_action->mo_app->mv_nav_mode = z2ui6_if_client=>cs_nav_mode-keep.
  ...
  METHOD test_nav_mode_inherited.
    DATA lo_http TYPE REF TO z2ui6_cl_ui5_handler.
    DATA lo_action TYPE REF TO z2ui6_cl_ui5_action.
    DATA lo_called TYPE REF TO z2ui6_cl_ui5_action.
    DATA lo_own TYPE REF TO z2ui6_cl_ui5_action.
  ...
  METHOD test_stateful_across_hop.
    ...
    NEW z2ui6_cl_ui5_client( action = lo_action )->z2ui6_if_client~set_session_stateful( abap_true ).
    ...
    NEW z2ui6_cl_ui5_client( action = lo_called )->z2ui6_if_client~set_session_stateful( abap_true ).
  ...
  METHOD test_stateful_cancels_out.
    DATA lo_http TYPE REF TO z2ui6_cl_ui5_handler.
    DATA lo_action TYPE REF TO z2ui6_cl_ui5_action.
    DATA lo_client TYPE REF TO z2ui6_cl_ui5_client.
    ...
    lo_client->z2ui6_if_client~set_session_stateful( abap_true ).
    lo_client->z2ui6_if_client~set_session_stateful( abap_false ).
  ...
  METHOD test_nav_mode_own_wins.
    ...
    DATA lo_target_core TYPE REF TO z2ui6_cl_ui5_app_cont.
    DATA lo_action TYPE REF TO z2ui6_cl_ui5_action.
    DATA lo_called TYPE REF TO z2ui6_cl_ui5_action.
    ...
    lo_target_core->mv_nav_mode = z2ui6_if_client=>cs_nav_mode-fresh.
  ...
  METHOD test_hop_clears_routing_req.
    ...
    lo_action->ms_next-s_nav-set_nav_routing = z2ui6_if_client=>cs_nav_mode-keep.
  ...
  METHOD test_stack_call_cross_class.
    ...
    lo_action->ms_next-t_action_front = VALUE #(
        ( slot = z2ui6_if_client=>cs_view-main method = z2ui6_if_ui5_types=>cs_slot_action-destroy )
        ( slot   = z2ui6_if_client=>cs_view-nested
          method = z2ui6_if_ui5_types=>cs_slot_action-display
          xml    = `<Nest/>` ) ).
  ...
  METHOD test_stack_leave_ancestor_gone.
    ...
    DATA lo_action TYPE REF TO z2ui6_cl_ui5_action.
    DATA lo_result TYPE REF TO z2ui6_cl_ui5_action.
    DATA lo_pop TYPE REF TO z2ui6_cl_ui5_action.
    ...
    NEW z2ui6_cl_ui5_srv_draft( )->create(
