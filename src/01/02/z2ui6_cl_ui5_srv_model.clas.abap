CLASS z2ui6_cl_ui5_srv_model DEFINITION PUBLIC FINAL.

  PUBLIC SECTION.

    METHODS constructor
      IMPORTING
        attri TYPE REF TO z2ui6_if_ui5_types=>ty_t_attri
    ...
    METHODS main_attri_search
      ...
      RETURNING
        VALUE(result) TYPE REF TO z2ui6_if_ui5_types=>ty_s_attri.
    ...
    DATA mt_attri TYPE REF TO z2ui6_if_ui5_types=>ty_t_attri.
    ...
    DATA mt_skipped TYPE z2ui6_if_client=>ty_t_model_skip.
  ...
  PRIVATE SECTION.
    ...
    METHODS attri_srtti_store
      IMPORTING
        ir_attri TYPE REF TO z2ui6_if_ui5_types=>ty_s_attri
        iv_val   TYPE any.
    ...
    METHODS attri_srtti_parse
      IMPORTING
        is_attri      TYPE z2ui6_if_ui5_types=>ty_s_attri
      RETURNING
    ...
    METHODS diss_struc
      IMPORTING
        ir_attri      TYPE REF TO z2ui6_if_ui5_types=>ty_s_attri
      RETURNING
        VALUE(result) TYPE z2ui6_if_ui5_types=>ty_t_attri.
    ...
    METHODS attri_create_new
      IMPORTING
        name          TYPE string
      RETURNING
        VALUE(result) TYPE z2ui6_if_ui5_types=>ty_s_attri.
    ...
    METHODS delta_apply_to_table
      IMPORTING
        io_val_front TYPE REF TO z2ui6_if_ajson
        iv_name      TYPE string
    ...
    METHODS delta_apply_nodes
      IMPORTING
        io_delta      TYPE REF TO z2ui6_if_ajson
        iv_base       TYPE string
    ...
    METHODS delta_apply_field
      IMPORTING
        io_delta    TYPE REF TO z2ui6_if_ajson
        iv_path     TYPE string
        is_cell     TYPE z2ui6_if_client=>ty_s_model_skip
    ...
    TYPES:
      BEGIN OF ty_s_resolved,
        name      TYPE string,
        type_kind TYPE string,
        attri     TYPE REF TO z2ui6_if_ui5_types=>ty_s_attri,
        ref       TYPE REF TO data,
    ...
    CLASS-DATA gi_mapper_upper TYPE REF TO z2ui6_if_ajson_mapping.
    CLASS-METHODS mapper_upper
      RETURNING
        VALUE(result) TYPE REF TO z2ui6_if_ajson_mapping.
...
CLASS z2ui6_cl_ui5_srv_model IMPLEMENTATION.
  ...
  METHOD main_json_stringify.
    TRY.
        ...
        " a no-op on it
        DATA(li_ajson_result) = CAST z2ui6_if_ajson( z2ui6_cl_ajson=>create_empty(
        ...
        DATA li_ajson_default TYPE REF TO z2ui6_if_ajson.

        TYPES: BEGIN OF ty_s_mapper_cache,
                 mapper TYPE REF TO z2ui6_if_ajson_mapping,
                 ajson  TYPE REF TO z2ui6_if_ajson,
        ...
        LOOP AT mt_attri->* REFERENCE INTO DATA(lr_attri) "#EC CI_SORTSEQ
             WHERE bind = abap_true
                   AND type_kind <> z2ui6_cl_ui5_util_context=>cv_typedescr_typekind_dref
                   AND type_kind <> z2ui6_cl_ui5_util_context=>cv_typedescr_typekind_oref.
          ...
          IF lr_attri->check_json = abap_true.
            li_ajson_result->set( iv_path = lr_attri->name_client
                               iv_val     = z2ui6_cl_ajson=>parse( <val> ) ).
            CONTINUE.
          ENDIF.
          ...
          IF lr_attri->custom_mapper IS BOUND OR lr_attri->custom_filter IS BOUND.
            IF lr_attri->custom_mapper IS BOUND.
              ...
              ELSE.
                ajson = z2ui6_cl_ajson=>create_empty(
            ...
            ELSE.
              IF li_ajson_default IS NOT BOUND.
                li_ajson_default = z2ui6_cl_ajson=>create_empty(
                                       ii_custom_mapping = mapper_upper( ) ).
              ENDIF.
  ...
  METHOD main_attri_db_load.
    ...
    LOOP AT mt_attri->* REFERENCE INTO DATA(lr_attri)   "#EC CI_SORTSEQ
      ...
      CASE lr_attri->type_kind.
        WHEN z2ui6_cl_ui5_util_context=>cv_typedescr_typekind_table.
          main_attri_db_load_table( lr_attri ).
        WHEN z2ui6_cl_ui5_util_context=>cv_typedescr_typekind_dref.
  ...
  METHOD main_attri_db_load_resolve.
    ...
    LOOP AT mt_attri->* REFERENCE INTO DATA(lr_attri)   "#EC CI_SORTSEQ
      ...
      ENDTRY.
      TRY.
          lr_attri->o_typedescr = z2ui6_cl_ui5_util_context=>rtti_get_typedescr_by_data_ref( lr_ref ).
        CATCH cx_root.
          CONTINUE.
      ENDTRY.
  ...
  METHOD attri_srtti_store.
    ...
    z2ui6_cl_ui5_util_context=>xml_srtti_stringify_pair( EXPORTING data    = iv_val
  ...
  METHOD attri_srtti_parse.
    ...
    IF is_attri-srtti_type IS NOT INITIAL.
      result = z2ui6_cl_ui5_util_context=>xml_srtti_parse_pair( iv_type = is_attri-srtti_type
    ...
    ELSE.
      ...
      result = z2ui6_cl_ui5_util_context=>xml_srtti_parse( is_attri-srtti_data ).
    ENDIF.
  ...
  METHOD main_attri_db_load_table.
    ...
    IF lr_attri_parent->type_kind <> z2ui6_cl_ui5_util_context=>cv_typedescr_typekind_dref.
      RETURN.
    ENDIF.
  ...
  METHOD main_attri_db_save_srtti.
    ...
    LOOP AT mt_attri->* REFERENCE INTO DATA(lr_attri)   "#EC CI_SORTSEQ
         WHERE type_kind = z2ui6_cl_ui5_util_context=>cv_typedescr_typekind_dref.
      ...
      IF <val_deref> IS NOT ASSIGNED.
        CONTINUE.
      ENDIF.
      DATA(lo_descr) = z2ui6_cl_ui5_util_context=>rtti_get_typedescr_by_data( <val_deref> ).
      ...
      CASE lo_descr->type_kind.
        ...
        WHEN z2ui6_cl_ui5_util_context=>cv_typedescr_typekind_table.
          ...
          LOOP AT mt_attri->* TRANSPORTING NO FIELDS USING KEY parent
               WHERE name_parent = lr_attri->name
                     ...
                     AND type_kind = z2ui6_cl_ui5_util_context=>cv_typedescr_typekind_table.
            attri_srtti_store( ir_attri = lr_attri
                               iv_val   = <val_deref> ).
            EXIT.
          ENDLOOP.

        WHEN z2ui6_cl_ui5_util_context=>cv_typedescr_typekind_struct1 OR z2ui6_cl_ui5_util_context=>cv_typedescr_typekind_struct2.
          attri_srtti_store( ir_attri = lr_attri
                             iv_val   = <val_deref> ).
        ...
        WHEN OTHERS.
          ...
          IF lo_descr->kind = z2ui6_cl_ui5_util_context=>cv_typedescr_kind_elem.
            attri_srtti_store( ir_attri = lr_attri
                               iv_val   = <val_deref> ).
          ENDIF.
  ...
  METHOD attri_search.
    ...
    DATA(lo_datadescr) = z2ui6_cl_ui5_util_context=>rtti_get_typedescr_by_data_ref( val ).

    IF lo_datadescr->type_kind = z2ui6_cl_ui5_util_context=>cv_typedescr_typekind_dref
        OR lo_datadescr->type_kind = z2ui6_cl_ui5_util_context=>cv_typedescr_typekind_oref.
      RAISE EXCEPTION TYPE z2ui6_cx_ui5_util_error
        EXPORTING
  ...
  METHOD attri_create_new.
    ...
    ref_idx_put( iv_name = name
                 ir_ref  = lr_ref ).
    DATA(lo_descr) = z2ui6_cl_ui5_util_context=>rtti_get_typedescr_by_data_ref( lr_ref ).
    result = VALUE z2ui6_if_ui5_types=>ty_s_attri( name        = name
  ...
  METHOD diss_dref.
    ...
    IF z2ui6_cl_ui5_util_context=>check_unassign_initial( lr_ref_tmp ).
      RETURN.
    ENDIF.

    DATA(lr_ref) = z2ui6_cl_ui5_util_context=>unassign_data( lr_ref_tmp ).
    ...
    CASE lo_descr->kind.
      ...
      WHEN z2ui6_cl_ui5_util_context=>cv_typedescr_kind_struct.
  ...
  METHOD diss_oref.
    ...
    IF z2ui6_cl_ui5_util_context=>check_unassign_initial( lr_val ).
      RETURN.
    ENDIF.

    DATA(lr_ref) = z2ui6_cl_ui5_util_context=>unassign_object( lr_val ).
    DATA(lt_attri) = z2ui6_cl_ui5_util_context=>rtti_get_t_attri_by_oref( lr_ref ).
    ...
    LOOP AT lt_attri REFERENCE INTO DATA(lr_attri) "#EC CI_SORTSEQ
         WHERE visibility   = z2ui6_cl_ui5_util_context=>cv_objectdescr_public
  ...
  METHOD diss_struc.
    ...
    IF ir_attri->o_typedescr->kind = z2ui6_cl_ui5_util_context=>cv_typedescr_kind_ref.
      DATA(lv_name) = |{ ir_attri->name }->|.
      DATA(lr_ref) = z2ui6_cl_ui5_util_context=>unassign_data( lr_val ).
    ELSE.
    ...
    DATA(lt_attri) = z2ui6_cl_ui5_util_context=>rtti_get_t_attri_by_any( lr_ref ).
  ...
  METHOD attri_update_entry_refs.
    ...
    LOOP AT mt_attri->* REFERENCE INTO DATA(lr_attri)   "#EC CI_SORTSEQ
         WHERE check_dissolved = abap_true
               AND (    type_kind = z2ui6_cl_ui5_util_context=>cv_typedescr_typekind_table
                     OR type_kind = z2ui6_cl_ui5_util_context=>cv_typedescr_typekind_dref
                     OR type_kind = z2ui6_cl_ui5_util_context=>cv_typedescr_typekind_struct1
                     OR type_kind = z2ui6_cl_ui5_util_context=>cv_typedescr_typekind_struct2 ).
      TRY.
          DATA(lr_ref) = attri_get_val_ref( lr_attri->name ).
        CATCH cx_root.
          CONTINUE.
      ...
      DATA(ls_resolved) = VALUE ty_s_resolved( name      = lr_attri->name
                                               ...
                                               attri     = lr_attri
                                               ref       = lr_ref ).
      IF lr_attri->type_kind = z2ui6_cl_ui5_util_context=>cv_typedescr_typekind_dref.
  ...
  METHOD entry_refs_pair_table.
    ...
    LOOP AT it_resolved REFERENCE INTO DATA(lr_other) "#EC CI_SORTSEQ
         WHERE type_kind = z2ui6_cl_ui5_util_context=>cv_typedescr_typekind_table
               AND ref = ir_res->ref
  ...
  METHOD entry_refs_recheck.
    ...
    IF sy-subrc = 0.
      ...
      IF ir_res->type_kind = z2ui6_cl_ui5_util_context=>cv_typedescr_typekind_dref.
  ...
  METHOD entry_refs_pair_dref.
    ...
    LOOP AT it_resolved REFERENCE INTO DATA(lr_other) "#EC CI_SORTSEQ
         WHERE (    type_kind = z2ui6_cl_ui5_util_context=>cv_typedescr_typekind_struct1
                 OR type_kind = z2ui6_cl_ui5_util_context=>cv_typedescr_typekind_struct2 )
  ...
  METHOD dissolve_run.
    ...
    IF mt_attri->* IS INITIAL.
      DATA(ls_attri) = VALUE z2ui6_if_ui5_types=>ty_s_attri( ).
      DATA(lt_init) = diss_oref( REF #( ls_attri ) ).
      INSERT LINES OF lt_init INTO TABLE mt_attri->*.
    ENDIF.

    DATA(lt_attri_new) = VALUE z2ui6_if_ui5_types=>ty_t_attri( ).
    ...
    LOOP AT mt_attri->* REFERENCE INTO DATA(lr_attri)   "#EC CI_SORTSEQ
      ...
      IF lr_attri->o_typedescr->kind = z2ui6_cl_ui5_util_context=>cv_typedescr_kind_ref
      ...
      CASE lr_attri->o_typedescr->kind.
        ...
        WHEN z2ui6_cl_ui5_util_context=>cv_typedescr_kind_ref.

          CASE lr_attri->o_typedescr->type_kind.

            WHEN z2ui6_cl_ui5_util_context=>cv_typedescr_typekind_oref.
  ...
  METHOD main_attri_refresh.
    ...
    DATA lt_attri TYPE z2ui6_if_ui5_types=>ty_t_attri.
  ...
  METHOD check_table_standard.
    ...
    result = z2ui6_cl_ui5_util_context=>rtti_check_table_standard( ir_ref ).
  ...
  METHOD mapper_upper.
    ...
    IF gi_mapper_upper IS NOT BOUND.
      gi_mapper_upper = z2ui6_cl_ajson_mapping=>create_upper_case( ).
    ENDIF.
  ...
  METHOD delta_col_kind.
    ...
    DATA(ls_col_kind) = VALUE ty_s_col_kind(
        field     = is_cell-field
        type_kind = z2ui6_cl_ui5_util_context=>rtti_get_type_kind( <comp> ) ).
    ...
    IF ls_col_kind-type_kind = z2ui6_cl_ui5_util_context=>cv_typedescr_typekind_table.
  ...
  METHOD delta_check_refused.
    ...
    IF iv_type_kind = z2ui6_cl_ui5_util_context=>cv_typedescr_typekind_dref
       OR iv_type_kind = z2ui6_cl_ui5_util_context=>cv_typedescr_typekind_oref.
      result = abap_true.
      RETURN.
    ENDIF.
    IF iv_type_kind <> z2ui6_cl_ui5_util_context=>cv_typedescr_typekind_table
       AND iv_type_kind <> z2ui6_cl_ui5_util_context=>cv_typedescr_typekind_struct1
       AND iv_type_kind <> z2ui6_cl_ui5_util_context=>cv_typedescr_typekind_struct2.
      RETURN.
    ENDIF.
    result = xsdbool( iv_node_type <> z2ui6_if_ajson_types=>node_type-object
                      AND iv_node_type <> z2ui6_if_ajson_types=>node_type-array ).
  ...
  METHOD scalar_apply.
    ...
    DATA(lv_type_kind) = z2ui6_cl_ui5_util_context=>rtti_get_type_kind( <val> ).
  ...
  METHOD whole_value_apply.
    ...
    DATA lo_val_front TYPE REF TO z2ui6_if_ajson.
    ...
    IF lv_node_type = z2ui6_if_ajson_types=>node_type-object
        OR lv_node_type = z2ui6_if_ajson_types=>node_type-array.
  ...
  METHOD whole_value_trace.
    ...
    DATA(ls_skip) = VALUE z2ui6_if_client=>ty_s_model_skip( name = iv_name ).
    TRY.
