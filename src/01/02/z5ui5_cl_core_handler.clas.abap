CLASS z5ui5_cl_core_handler DEFINITION
  PUBLIC FINAL
  CREATE PUBLIC.
  ...
  PUBLIC SECTION.
    ...
    DATA ms_request      TYPE z5ui5_if_core_types=>ty_s_request.
    DATA ms_response     TYPE z5ui5_if_core_types=>ty_s_response.
...
CLASS z5ui5_cl_core_handler IMPLEMENTATION.
  ...
  METHOD main_begin.
    TRY.
        ...
        DATA(lo_json_mapper) = NEW z5ui5_cl_core_srv_json( ).
        ...
        ELSEIF ms_request-s_control-app_start IS NOT INITIAL.
          NEW z5ui5_cl_core_srv_draft( )->cleanup( ).
  ...
  METHOD main_end.
    ...
    IF    ms_response-s_front-params-s_view-check_update_model        = abap_true
      ...
      DATA(lo_model) = NEW z5ui5_cl_core_srv_attri( attri = mo_action->mo_app->mt_attri
    ...
    IF CAST z5ui5_if_app( mo_action->mo_app->mo_app )->check_sticky = abap_false.
