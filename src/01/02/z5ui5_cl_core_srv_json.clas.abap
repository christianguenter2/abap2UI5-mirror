CLASS z5ui5_cl_core_srv_json DEFINITION
  PUBLIC FINAL
  CREATE PUBLIC.
  ...
  PUBLIC SECTION.
    ...
    METHODS request_json_to_abap
      IMPORTING
        val           TYPE string
      RETURNING
        VALUE(result) TYPE z5ui5_if_core_types=>ty_s_request.

    METHODS response_abap_to_json
      IMPORTING
        val           TYPE z5ui5_if_core_types=>ty_s_response
      RETURNING
...
CLASS z5ui5_cl_core_srv_json IMPLEMENTATION.
    ...
    LOOP AT t_attri->* REFERENCE INTO DATA(lr_attri)
      ...
      TRY.
        ...
        CATCH cx_root INTO DATA(x).
          z5ui5_cl_util=>x_raise( |JSON_PARSING_ERROR: { x->get_text( ) } | ).
      ENDTRY.
    ENDLOOP.
    ...
    TRY.
        ...
        LOOP AT t_attri->* REFERENCE INTO DATA(lr_attri) WHERE bind_type <> ``.
          ...
          IF lr_attri->custom_mapper IS BOUND.
            DATA(ajson) = CAST z5ui5_if_ajson( z5ui5_cl_ajson=>create_empty(
                                                   ii_custom_mapping = lr_attri->custom_mapper ) ).
          ELSE.
            ajson = CAST z5ui5_if_ajson( z5ui5_cl_ajson=>create_empty(
  ...
  METHOD request_json_to_abap.
    TRY.
        ...
        result-s_control-app_start = z5ui5_cl_util=>c_trim_upper(
                                         z5ui5_cl_util=>url_param_get( val = `app_start`
  ...
  METHOD response_abap_to_json.
    TRY.
        ...
        ajson_result->set( iv_path = `/`
                           iv_val  = val-s_front ).
        ajson_result = ajson_result->filter( NEW z5ui5_cl_core_srv_json( ) ).
