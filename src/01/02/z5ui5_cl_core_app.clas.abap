...
CLASS z5ui5_cl_core_app IMPLEMENTATION.
  ...
  METHOD all_xml_parse.
    ...
    z5ui5_cl_util=>xml_parse( EXPORTING xml = xml
  ...
  METHOD all_xml_stringify.
    ...
    TRY.
        ...
        DATA(lo_model) = NEW z5ui5_cl_core_srv_attri( attri = mt_attri
                                                      app   = mo_app ).
      ...
      CATCH cx_root INTO DATA(x2).
        TRY.
            ...
            DATA(lo_dissolver) = NEW z5ui5_cl_core_srv_diss( attri = mt_attri
                                                             app   = mo_app ).

            lo_dissolver->main( ).
            lo_dissolver->main( ).
            lo_model = NEW z5ui5_cl_core_srv_attri( attri = mt_attri
                                                    app   = mo_app ).
            lo_model->attri_before_save( ).
  ...
  METHOD db_load.
    ...
    DATA(lo_db) = NEW z5ui5_cl_core_srv_draft( ).
    DATA(ls_db) = lo_db->read_draft( id ).
    result = all_xml_parse( ls_db-data ).

    DATA(lo_model) = NEW z5ui5_cl_core_srv_attri( attri = result->mt_attri
                                                  app   = result->mo_app ).
  ...
  METHOD db_save.
    ...
    IF mo_app IS BOUND.
      ...
      CAST z5ui5_if_app( mo_app )->check_initialized = abap_true.
    ENDIF.
