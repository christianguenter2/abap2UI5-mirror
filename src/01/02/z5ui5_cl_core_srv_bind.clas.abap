CLASS z5ui5_cl_core_srv_bind DEFINITION
  PUBLIC FINAL
  CREATE PUBLIC.
...
CLASS z5ui5_cl_core_srv_bind IMPLEMENTATION.
  METHOD bind_tab_cell.
    ...
    DATA(lt_attri) = z5ui5_cl_util=>rtti_get_t_attri_by_any( ms_config-tab ).
  ...
  METHOD check_raise_existing.
    ...
    IF mr_attri->custom_mapper IS BOUND.
      ...
      DATA(lv_name1) = z5ui5_cl_util=>rtti_get_classname_by_ref( mr_attri->custom_mapper ).
      DATA(lv_name2) = z5ui5_cl_util=>rtti_get_classname_by_ref( ms_config-custom_mapper ).
  ...
  METHOD main.
    ...
    DATA(lo_model) = NEW z5ui5_cl_core_srv_attri( attri = mo_app->mt_attri
                                                  app   = mo_app->mo_app ).
  ...
  METHOD main_cell.
    ...
    DATA(lo_bind) = NEW z5ui5_cl_core_srv_bind( mo_app ).
  ...
  METHOD update_model_attri.
    ...
    mr_attri->view               = COND #( WHEN ms_config-view IS INITIAL
                                           THEN z5ui5_if_client=>cs_view-main
                                           ELSE ms_config-view ).
