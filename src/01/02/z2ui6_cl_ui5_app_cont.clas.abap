CLASS z2ui6_cl_ui5_app_cont DEFINITION PUBLIC FINAL.
  ...
  PUBLIC SECTION.
    ...
    DATA ms_draft TYPE z2ui6_cl_ui5_srv_draft=>ty_s_draft.
    ...
    DATA ms_session TYPE z2ui6_if_ui5_types=>ty_s_session.
    ...
    METHODS model_json_parse
      ...
      RETURNING
        VALUE(result) TYPE z2ui6_if_client=>ty_t_model_skip.
...
CLASS z2ui6_cl_ui5_app_cont IMPLEMENTATION.

  METHOD all_xml_parse.

    z2ui6_cl_ui5_util_context=>xml_parse( EXPORTING xml = xml
  ...
  METHOD all_xml_stringify.
    ...
    TRY.
        ...
        result = z2ui6_cl_ui5_util_context=>xml_stringify( me ).
  ...
  METHOD db_save.
    ...
    NEW z2ui6_cl_ui5_srv_draft( )->create( draft     = ms_draft
  ...
  METHOD draft_parse.
    ...
    DATA(ls_db) = NEW z2ui6_cl_ui5_srv_draft( )->read_draft( iv_id ).
  ...
  METHOD create_model.
    ...
    result = NEW z2ui6_cl_ui5_srv_model( attri = mt_attri
                                         app   = mo_app ).
