...
CLASS z5ui5_cl_core_handler DEFINITION LOCAL FRIENDS ltcl_test_handler_post.
...
CLASS ltcl_test_handler_post IMPLEMENTATION.
  METHOD load_startup_app.
    ...
    DATA(lo_post) = NEW z5ui5_cl_core_handler( lv_payload ).
    lo_post->main_begin( ).
    ...
    DATA(lo_startup) = CAST z5ui5_cl_app_startup( lo_post->mo_action->mo_app->mo_app ) ##NEEDED.
