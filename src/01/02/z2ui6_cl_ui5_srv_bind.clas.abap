CLASS z2ui6_cl_ui5_srv_bind DEFINITION PUBLIC FINAL.
  ...
  PUBLIC SECTION.
    ...
    METHODS constructor
      IMPORTING
        app TYPE REF TO z2ui6_cl_ui5_app_cont.

    METHODS main
      IMPORTING
        val           TYPE REF TO data
        config        TYPE z2ui6_if_ui5_types=>ty_s_bind_config OPTIONAL
      RETURNING
  ...
  PRIVATE SECTION.
    ...
    DATA mr_attri  TYPE REF TO z2ui6_if_ui5_types=>ty_s_attri.
    DATA ms_config TYPE z2ui6_if_ui5_types=>ty_s_bind_config.
    ...
    METHODS main_cell
      IMPORTING
        val           TYPE REF TO data
        config        TYPE z2ui6_if_ui5_types=>ty_s_bind_config
      RETURNING
        VALUE(result) TYPE string.
...
CLASS z2ui6_cl_ui5_srv_bind IMPLEMENTATION.
  ...
  METHOD bind_tab_cell.
    ...
    IF mr_cell_tab <> ms_config-tab.
      ...
      DATA(lv_kind) = z2ui6_cl_ui5_util_context=>rtti_get_type_kind( <row> ).
      IF lv_kind <> z2ui6_cl_ui5_util_context=>cv_typedescr_typekind_struct1
          AND lv_kind <> z2ui6_cl_ui5_util_context=>cv_typedescr_typekind_struct2.
        RAISE EXCEPTION TYPE z2ui6_cx_ui5_util_error
          EXPORTING
      ...
      CLEAR mt_cell_names.
      DATA(lt_attri) = z2ui6_cl_ui5_util_context=>rtti_get_t_attri_by_any( ms_config-tab ).
  ...
  METHOD check_same_impl.
    ...
    IF ir_existing IS BOUND AND ir_new IS BOUND
        AND z2ui6_cl_ui5_util_context=>rtti_get_classname_by_ref( ir_existing )
         <> z2ui6_cl_ui5_util_context=>rtti_get_classname_by_ref( ir_new ).
      RAISE EXCEPTION TYPE z2ui6_cx_ui5_util_error
  ...
  METHOD check_serializable.
    ...
    IF z2ui6_cl_ui5_util_context=>rtti_check_serializable( ir_ref ) = abap_false.
      RAISE EXCEPTION TYPE z2ui6_cx_ui5_util_error
  ...
  METHOD get_model.
    ...
    IF mo_model IS NOT BOUND.
      mo_model = NEW z2ui6_cl_ui5_srv_model( attri = mo_app->mt_attri
                                             app   = mo_app->mo_app ).
    ENDIF.
    result = mo_model.
  ...
  METHOD main.
    ...
    IF z2ui6_cl_ui5_util_context=>check_bound_a_not_initial( config-tab ).
