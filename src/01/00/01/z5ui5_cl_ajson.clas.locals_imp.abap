    ...
    CASE lo_type->type_kind.
      ...
      WHEN lif_kind=>table.
        ...
        IF lo_table_type->table_kind <> cl_abap_tabledescr=>tablekind_std.
          z5ui5_cx_ajson_error=>raise( 'Unsupported type of input table (must be standard table)' ).
        ENDIF.
        TRY.
          ...
          CATCH cx_root.
            z5ui5_cx_ajson_error=>raise( 'Error converting input table (should be string_table)' ).
        ENDTRY.
      WHEN OTHERS.
        z5ui5_cx_ajson_error=>raise( 'Unsupported type of input (must be char, string, string_table, or xstring)' ).
    ENDCASE.
