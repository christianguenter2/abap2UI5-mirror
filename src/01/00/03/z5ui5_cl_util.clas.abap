CLASS z5ui5_cl_util DEFINITION
  PUBLIC
  INHERITING FROM z5ui5_cl_abap_api
  CREATE PUBLIC.
  ...
  PUBLIC SECTION.
    ...
    CLASS-METHODS rtti_get_t_ddic_fixed_values
      ...
      RETURNING
        VALUE(result) TYPE z5ui5_cl_abap_api=>ty_t_fix_val ##NEEDED.
...
CLASS z5ui5_cl_util IMPLEMENTATION.
  ...
  METHOD filter_update_tokens.
    ...
    DATA(lt_range) = z5ui5_cl_util=>filter_get_range_t_by_token_t( result[ name = name ]-t_token ).
  ...
  METHOD json_parse.
    TRY.
        ...
        z5ui5_cl_ajson=>parse( val )->to_abap( EXPORTING iv_corresponding = abap_true
