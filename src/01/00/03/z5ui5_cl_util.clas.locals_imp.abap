  ...
  PUBLIC SECTION.
    CLASS-METHODS msg_map
      IMPORTING
        name          TYPE clike
        val           TYPE data
        is_msg        TYPE z5ui5_cl_util=>ty_s_msg
      RETURNING
        VALUE(result) TYPE z5ui5_cl_util=>ty_s_msg.

    CLASS-METHODS msg_get
      IMPORTING
        val           TYPE any
      RETURNING
        VALUE(result) TYPE z5ui5_cl_util=>ty_t_msg.
...
CLASS lcl_msp_mapper IMPLEMENTATION.
  ...
  METHOD msg_get.
    ...
    DATA(lv_kind) = z5ui5_cl_util=>rtti_get_type_kind( val ).
    CASE lv_kind.
      ...
      WHEN cl_abap_datadescr=>typekind_struct1 OR cl_abap_datadescr=>typekind_struct2.
        ...
        DATA(lt_attri) = z5ui5_cl_util=>rtti_get_t_attri_by_any( val ).

        DATA(ls_result) = VALUE z5ui5_cl_util=>ty_s_msg( ).
      ...
      WHEN cl_abap_datadescr=>typekind_oref.
        TRY.
            ...
            DATA(lt_attri_o) = z5ui5_cl_util=>rtti_get_t_attri_by_oref( val ).
              ...
              CATCH cx_root.
                ...
                TRY.
                  ...
                  CATCH cx_root INTO DATA(lx2).
                    ...
                    lt_attri_o = z5ui5_cl_util=>rtti_get_t_attri_by_oref( val ).
      ...
      WHEN OTHERS.
        ...
        IF z5ui5_cl_util=>rtti_check_clike( val ).
