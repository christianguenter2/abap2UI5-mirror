...
CLASS ltcl_unit_test IMPLEMENTATION.
  METHOD test_boolean_check.
    ...
    cl_abap_unit_assert=>assert_true( z5ui5_cl_util=>boolean_check_by_data( lv_bool ) ).

    lv_bool = xsdbool( 1 = 2 ).
    cl_abap_unit_assert=>assert_true( z5ui5_cl_util=>boolean_check_by_data( lv_bool ) ).

    cl_abap_unit_assert=>assert_true( z5ui5_cl_util=>boolean_check_by_data( abap_true ) ).

    cl_abap_unit_assert=>assert_true( z5ui5_cl_util=>boolean_check_by_data( abap_false ) ).
  ...
  METHOD test_sql_get_by_string.
    ...
    DATA(lv_test) = ``.
    DATA(ls_sql) = z5ui5_cl_util=>filter_get_sql_by_sql_string( lv_test ) ##NEEDED.
  ...
  METHOD test_check_bound_a_not_inital.
    ...
    cl_abap_unit_assert=>assert_true( z5ui5_cl_util=>check_bound_a_not_inital( lr_test ) ).
    CLEAR lv_test.
    cl_abap_unit_assert=>assert_false( z5ui5_cl_util=>check_bound_a_not_inital( lr_test ) ).
    CLEAR lr_test.
    cl_abap_unit_assert=>assert_false( z5ui5_cl_util=>check_bound_a_not_inital( lr_test ) ).
  ...
  METHOD test_check_unassign_inital.
    ...
    cl_abap_unit_assert=>assert_false( z5ui5_cl_util=>check_unassign_inital( lr_test ) ).

    CLEAR lv_test.
    cl_abap_unit_assert=>assert_true( z5ui5_cl_util=>check_unassign_inital( lr_test ) ).
  ...
  METHOD rtti_check_ref_data.
    ...
    cl_abap_unit_assert=>assert_true( z5ui5_cl_util=>rtti_check_ref_data( lr_data ) ).

    cl_abap_unit_assert=>assert_false( z5ui5_cl_util=>rtti_check_ref_data( lv_test ) ).
  ...
  METHOD conv_copy_ref_data.
    ...
    DATA(lr_test2) = z5ui5_cl_util=>conv_copy_ref_data( lr_data ).
  ...
  METHOD test_time_get_timestampl.
    ...
    DATA(lv_time2) = z5ui5_cl_util=>time_substract_seconds( time    = lv_time
                                                            seconds = 60 * 60 * 4 ).
  ...
  METHOD test_func_get_user_tech.
    ...
    cl_abap_unit_assert=>assert_equals( exp = z5ui5_cl_util=>context_get_user_tech( )
                                        act = sy-uname ).

    cl_abap_unit_assert=>assert_not_initial( z5ui5_cl_util=>context_get_user_tech( ) ).
  ...
  METHOD test_url_param_create_url.
    ...
    DATA(lt_param) = z5ui5_cl_util=>url_param_get_tab(
  ...
  METHOD test_rtti_check_type_kind.
    ...
    DATA(lv_string) = VALUE string( ).
    DATA lr_string TYPE REF TO string.
    cl_abap_unit_assert=>assert_false( z5ui5_cl_util=>rtti_check_type_kind_dref( lv_string ) ).

    CREATE DATA lr_string.
    cl_abap_unit_assert=>assert_true( z5ui5_cl_util=>rtti_check_type_kind_dref( lr_string ) ).
  ...
  METHOD test_rtti_get_t_comp_by_struc.
    ...
    DATA(lt_comp) = z5ui5_cl_util=>rtti_get_t_attri_by_any( ls_row ).
  ...
  METHOD test_trans_xml_2_any__w_obj.
    ...
    CLEAR lo_obj.
    z5ui5_cl_util=>xml_parse( EXPORTING xml = lv_xml
  ...
  METHOD test_get_token_t_by_r_t.
    ...
    DATA(lt_range) = VALUE z5ui5_cl_util=>ty_t_range( ( sign = 'I' option = 'EQ' low = `table` high = `` )
     ).

    DATA(lt_result) = z5ui5_cl_util=>filter_get_token_t_by_range_t( lt_range ).

    DATA(lt_exp) = VALUE z5ui5_cl_util=>ty_t_token(
  ...
  METHOD test_rtti_get_t_attri_by_incl.
    ...
    DATA(lt_attri) = z5ui5_cl_util=>rtti_get_t_attri_by_include( CAST #( lo_datadescr ) ).
